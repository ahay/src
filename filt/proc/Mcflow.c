...
{
    int n12, i, i1, i2, rect, order;
    float **img, **grad, **grad1, **grad2, *tmp, med, t, t2, tol[2], **x;
    sf_eno2 g[2];
    sf_file in, out;
    ...
    /* diffusion */
    sf_int2_init (x, 0,0,1,1,n1,n2, sf_lin_int, 2, n12);
    triangle2_init(rect,rect, nx, ny);
