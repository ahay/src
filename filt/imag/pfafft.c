...
void pfacc (int isign, int n, float complex cz[])
/*****************************************************************************
...
*****************************************************************************/
{
    ...
    pfacc(isign,n/2,(float complex*)z);
}
...
void pfamcc (int isign, int n, int nt, int k, int kt, float complex cz[])
/*****************************************************************************
...
void pfa2cc (int isign, int idim, int n1, int n2, float complex cz[])
/*****************************************************************************
...
void pfa2cr (int isign, int idim, int n1, int n2, float complex cz[], float rz[])
/*****************************************************************************
...
*****************************************************************************/
{
    ...
    if (idim==1) {
        ...
        pfa2cc(isign,1,n1/2,n2,(float complex*)z);

    /* else, if transforming dimension 2 */
    } else {

        /* transform as complex elements */
        pfa2cc(isign,2,n1,n2/2,(float complex*)z);
...
void pfa2rc (int isign, int idim, int n1, int n2, float rz[], float complex cz[])
/*****************************************************************************
