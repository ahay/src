...
//                sf_warning("bs=%f,br=%f,iz=%d",crealf(wexmvaop->bws[ompith][iz][0][100]),crealf(wexmvaop->bwr[ompith][iz][0][100]),iz);
...
//                sf_warning("ps=%f,pr=%f,iz=%d",crealf(wexmvaop->dws[ompith][0][100]),crealf(wexmvaop->dwr[ompith][0][100]),iz);

                /* Wavefield Scattering (W.S.) dW -> dS */
                wexlsr_w2s(wr,wexmvaop->bws[ompith][iz],cub,lsr,slo,wexmvaop->dws[ompith],wexmvaop->stmp[ompith],iz,ompith);
