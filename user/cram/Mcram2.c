...
int main (int argc, char* argv[]) {
    ...
    /* Data object */
    cram_data = sf_cram_data2_init (data, false);
    /* Survey object */
    ...
    if (sf_getstring ("full")) {
        /* Full image (opening angle, dip angle, z, x) */
