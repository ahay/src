...
program mexwell_sponge2_adjtest
  use rsf
  implicit none

  logical :: order1,attenuating,adj
  ...
  call from_par("adj",adj,.false.) ! add attenuation or not
  ...
  call exit(0)
end program mexwell_sponge2_adjtest
     ...
     do i2=5,nxpad-3
        do i1=5,nzpad-3
           diff1=c1*(vz(i1,i2)/rho(i1,i2)-vz(i1-1,i2)/rho(i1-1,i2))&
                +c2*(vz(i1+1,i2)/rho(i1+1,i2)-vz(i1-2,i2)/rho(i1-2,i2))&
                +c3*(vz(i1+2,i2)/rho(i1+2,i2)-vz(i1-3,i2)/rho(i1-3,i2))&
                +c4*(vz(i1+3,i2)/rho(i1+3,i2)-vz(i1-4,i2)/rho(i1-4,i2))
           diff2=c1*(vx(i1,i2)/rho(i1,i2)-vx(i1,i2-1)/rho(i1,i2-1))&
                +c2*(vx(i1,i2+1)/rho(i1,i2+1)-vx(i1,i2-2)/rho(i1,i2-2))&
                +c3*(vx(i1,i2+2)/rho(i1,i2+2)-vx(i1,i2-3)/rho(i1,i2-3))&
                +c4*(vx(i1,i2+3)/rho(i1,i2+3)-vx(i1,i2-4)/rho(i1,i2-4))
           p(i1,i2)=p(i1,i2)-dt*(idz*diff1+idx*diff2)
        enddo
     enddo
     do i2=4,nxpad-4
        do i1=4,nzpad-4
