...
__global__ void cuda_forward_p_2(float *vel, float *p0, float *p1, float *vx, float *vz, float dt, float _dx, float _dz, int npml, int nnz, int nnx)
{
	int i1=threadIdx.x+blockIdx.x*blockDim.x;
	int i2=threadIdx.y+blockIdx.y*blockDim.y;
	int id=i1+i2*nnz;
...
__global__ void cuda_forward_p_4(float *vel, float *p0, float *p1, float *vx, float *vz, float dt, float _dx, float _dz, int npml, int nnz, int nnx)
{
	int i1=blockIdx.x*blockDim.x+threadIdx.x;
	int i2=blockIdx.y*blockDim.y+threadIdx.y;
	int id=i1+i2*nnz;
...
__global__ void cuda_forward_p_6(float *vel, float *p0, float *p1, float *vx, float *vz, float dt, float _dx, float _dz, int npml, int nnz, int nnx)
{
	int i1=blockIdx.x*blockDim.x+threadIdx.x;
	int i2=blockIdx.y*blockDim.y+threadIdx.y;
	int id=i1+i2*nnz;
...
__global__ void cuda_forward_p_8(float *vel, float *p0, float *p1, float *vx, float *vz, float dt, float _dx, float _dz, int npml, int nnz, int nnx)
{
	int i1=blockIdx.x*blockDim.x+threadIdx.x;
	int i2=blockIdx.y*blockDim.y+threadIdx.y;
	int id=i1+i2*nnz;
...
__global__ void cuda_forward_p_10(float *vel, float *p0, float *p1, float *vx, float *vz, float dt, float _dx, float _dz, int npml, int nnz, int nnx)
{
	int i1=blockIdx.x*blockDim.x+threadIdx.x;
	int i2=blockIdx.y*blockDim.y+threadIdx.y;
	int id=i1+i2*nnz;
