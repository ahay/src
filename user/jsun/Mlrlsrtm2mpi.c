...
int main(int argc, char* argv[]) 
{
    ...
    if (!sf_getbool("illum", &illum)) illum=true; /*if n, no source illumination */
...
#pragma omp parallel for private(ix,it)
	...
	for (ix=0; ix<gpl; ix++)
      ...
      lrosback2(img, wavefld, sill, tmprec, adj, verb, wantwf, ltb, rtb, m2b, geop, pad1, wavefld2, illum);
