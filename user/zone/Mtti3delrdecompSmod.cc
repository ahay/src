...
/* for low-rank decomp. */
static int samplebsxx(vector<int>& rs, vector<int>& cs, DblNumMat& res);
static int samplebsyy(vector<int>& rs, vector<int>& cs, DblNumMat& res);
static int samplebszz(vector<int>& rs, vector<int>& cs, DblNumMat& res);
static int samplebsxy(vector<int>& rs, vector<int>& cs, DblNumMat& res);
static int samplebsxz(vector<int>& rs, vector<int>& cs, DblNumMat& res);
static int samplebsyz(vector<int>& rs, vector<int>& cs, DblNumMat& res);
...
int main(int argc, char* argv[])
{
   ...
   * ***************************************************************************/
   ...
   /********* qS-bx: Ay2+Az2 **********/
   iC( ddlowrank(nxyz,nk,samplebsxx,eps,npk,lid,rid,mid) );
   m2xx=mid.m();
   n2xx=mid.n();
   ...
   iC ( samplebsxx(md,lid,mat) );
   map2d1d(ldataxx, mat, nxyz, m2xx);

   iC ( samplebsxx(rid,nd,mat) );
   map2d1d(rdataxx, mat, n2xx, nk);

   /********* qS-by: Ax2+Az2 **********/
   iC( ddlowrank(nxyz,nk,samplebsyy,eps,npk,lid,rid,mid) );
   m2yy=mid.m();
   n2yy=mid.n();
   ...
   iC ( samplebsyy(md,lid,mat) );
   map2d1d(ldatayy, mat, nxyz, m2yy);

   iC ( samplebsyy(rid,nd,mat) );
   map2d1d(rdatayy, mat, n2yy, nk);

   /********* qS-bz: Ax2+Ay2 **********/
   iC( ddlowrank(nxyz,nk,samplebszz,eps,npk,lid,rid,mid) );
   m2zz=mid.m();
   n2zz=mid.n();
   ...
   iC ( samplebszz(md,lid,mat) );
   map2d1d(ldatazz, mat, nxyz, m2zz);

   iC ( samplebszz(rid,nd,mat) );
   map2d1d(rdatazz, mat, n2zz, nk);

   /********* AxAy-operator **********/
   iC( ddlowrank(nxyz,nk,samplebsxy,eps,npk,lid,rid,mid) );
   m2xy=mid.m();
   n2xy=mid.n();
   ...
   iC ( samplebsxy(md,lid,mat) );
   map2d1d(ldataxy, mat, nxyz, m2xy);

   iC ( samplebsxy(rid,nd,mat) );
   map2d1d(rdataxy, mat, n2xy, nk);

   /********* AxAz-operator **********/
   iC( ddlowrank(nxyz,nk,samplebsxz,eps,npk,lid,rid,mid) );
   m2xz=mid.m();
   n2xz=mid.n();
   ...
   iC ( samplebsxz(md,lid,mat) );
   map2d1d(ldataxz, mat, nxyz, m2xz);

   iC ( samplebsxz(rid,nd,mat) );
   map2d1d(rdataxz, mat, n2xz, nk);

   /********* AyAz-operator **********/
   iC( ddlowrank(nxyz,nk,samplebsyz,eps,npk,lid,rid,mid) );
   m2yz=mid.m();
   n2yz=mid.n();
   ...
   iC ( samplebsyz(md,lid,mat) );
   map2d1d(ldatayz, mat, nxyz, m2yz);

   iC ( samplebsyz(rid,nd,mat) );
   ...
   ikxikyikz(ijkx, ijky, ijkz, nkx, nky, nkz);
    ...
    sf_file Fsx, Fsy, Fsz;
    Fsx= sf_output("out");
    Fsy= sf_output("ElasticSy");
    Fsz= sf_output("ElasticSz");
    ...
    // separate and decompose qS wave 
    sf_warning("vector decomposition of S-wave based on lowrank decomp.");
    decomplowrank3ds(ldataxx, rdataxx, fmidxx,
