/* 3-D three-components wavefield modeling based on original elastic anisotropic displacement 
  wave equation and vector decomposition using low-rank symbol approximation in 3D ORT media (qS2). */
/*
...
int main(int argc, char* argv[])
{
   ...
   * ***************************************************************************/
   ...
   ikxikyikz(ijkx, ijky, ijkz, nkx, nky, nkz);
    ...
    sf_file Fpx, Fpy, Fpz;
    Fpx= sf_output("out");
    Fpy= sf_output("ElasticS2y");
    Fpz= sf_output("ElasticS2z");
    ...
    for (snap=0;snap<nt;snap++) {
		...
		// separate qP wave 
		sf_warning("vector decomposition of S2-wave based on lowrank decomp.");
