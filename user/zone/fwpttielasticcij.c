/* Forward propagating using original elastic equation of displacement in TTI media */ 
/* *************************************************************************
...
void fwpttielastic3d(float dt2,float***p1,float***p2,float***p3,float***q1,float***q2,float***q3,
		     ...
		     float* coeff_1dx,float* coeff_1dy,float* coeff_1dz,
                     ...
                     float ***c11,float ***c33, float ***c13, float ***c55, float ***c66,
...
/*< fwpttielastic3d: forward-propagating using original elastic equation of displacement in 3D TTI media>*/
{
    ...
    float a11, a33, a44, a13, a66, a11a66, a13a44;
...
#pragma omp parallel for private(i,j,k,l,hpy, hqy, hry, hpx, hqx, hrx, hpz, hqz, hrz, px2, py2, pz2, qx2, qy2, qz2, rx2, ry2, rz2, qxy1, rxz1, pxy1, ryz1, pxz1, qyz1) \
    ...
    shared(p1,p2,p3,q1,q2,q3,r1,r2,r3,					\
	   ...
	   c11,c33,c13,c55,c66,theta,phai,dt2)
#endif
    for(k=0;k<nypad;k++)
	for(i=0;i<nxpad;i++)
	    for(j=0;j<nzpad;j++)
