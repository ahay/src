/* 3-D three-components wavefield modeling using pseudo-pure mode SV-wave equation in 3D VTI media.
...
int main(int  argc,char **argv)
{
    ...
    float *coeff_2dx,*coeff_2dy,*coeff_2dz,*coeff_1dx,*coeff_1dy,*coeff_1dz;
       ...
       coeff_1dz=sf_floatalloc(mmix);
        ...
        /* setup I/O files */
        Fo1 = sf_output("out");          /* pseudo-pure qSV-wave xy-component */
        Fo2 = sf_output("PseudoPureSVz"); /* pseudo-pure qSV-wave z-component */
        Fo3 = sf_output("PseudoPureSV"); /* pseudo-pure scalar qSV-wave */
	...
	for(it=0;it<ns;it++)
	{
        ...
        //sf_warning("t=%f f0=%f t0=%f A=%f",t, f0, t0, A);
		 ...
		 sf_warning("p2=%f r2=%f\n", p2[isy][isx][isz],r2[isy][isx][isz]);
  	     ...
  	     fwpvti3dpseudosv(dt,p1,p2,p3,r1,r2,r3,
                          coeff_2dx,coeff_2dy,coeff_2dz,coeff_1dx,coeff_1dy,coeff_1dz,
	                      vp0,vs0,epsi,del,
                          nxpad,nypad,nzpad,dx,dy,dz);
