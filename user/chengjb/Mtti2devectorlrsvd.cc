...
int main(int argc, char* argv[])
{
   ...
   * ***************************************************************************/
   ...
   int   m2opx1, n2opx1;
   float *ldataopx1, *fmidopx1, *rdataopx1;
   ...
   fmidopx1  = sf_floatalloc(m2opx1*n2opx1);
   ldataopx1 = sf_floatalloc(nxz*m2opx1);
   rdataopx1 = sf_floatalloc(n2opx1*nk);
   ...
   int   m2opx2, n2opx2;
   float *ldataopx2, *fmidopx2, *rdataopx2;
   ...
   fmidopx2  = sf_floatalloc(m2opx2*n2opx2);
   ldataopx2 = sf_floatalloc(nxz*m2opx2);
   rdataopx2 = sf_floatalloc(n2opx2*nk);
   ...
   int   m2opz1, n2opz1;
   float *ldataopz1, *fmidopz1, *rdataopz1;
   ...
   fmidopz1  = sf_floatalloc(m2opz1*n2opz1);
   ldataopz1 = sf_floatalloc(nxz*m2opz1);
   rdataopz1 = sf_floatalloc(n2opz1*nk);
   ...
   /********* qP-wave low rank decomposition of operator BpxAxz + BpxzAz applying to uz **********/
   int   m2opz2, n2opz2;
   float *ldataopz2, *fmidopz2, *rdataopz2;
   ...
   fmidopz2  = sf_floatalloc(m2opz2*n2opz2);
   ldataopz2 = sf_floatalloc(nxz*m2opz2);
   rdataopz2 = sf_floatalloc(n2opz2*nk);
   ...
   int   m2osx1, n2osx1;
   float *ldataosx1, *fmidosx1, *rdataosx1;
   ...
   fmidosx1  = sf_floatalloc(m2osx1*n2osx1);
   ldataosx1 = sf_floatalloc(nxz*m2osx1);
   rdataosx1 = sf_floatalloc(n2osx1*nk);
   ...
   /********* qP-wave low rank decomposition of operator BpxAxz + BpxzAz applying to uz **********/
   int   m2osx2, n2osx2;
   float *ldataosx2, *fmidosx2, *rdataosx2;
   ...
   fmidosx2  = sf_floatalloc(m2osx2*n2osx2);
   ldataosx2 = sf_floatalloc(nxz*m2osx2);
   rdataosx2 = sf_floatalloc(n2osx2*nk);
   ...
   /********* qP-wave low rank decomposition of operator BpxzAx + BpzAxz applying to ux **********/
   int   m2osz1, n2osz1;
   float *ldataosz1, *fmidosz1, *rdataosz1;
   ...
   fmidosz1  = sf_floatalloc(m2osz1*n2osz1);
   ldataosz1 = sf_floatalloc(nxz*m2osz1);
   rdataosz1 = sf_floatalloc(n2osz1*nk);
   ...
   /********* qP-wave low rank decomposition of operator BpxAxz + BpxzAz applying to uz **********/
   int   m2osz2, n2osz2;
   float *ldataosz2, *fmidosz2, *rdataosz2;
   ...
   fmidosz2  = sf_floatalloc(m2osz2*n2osz2);
   ldataosz2 = sf_floatalloc(nxz*m2osz2);
   rdataosz2 = sf_floatalloc(n2osz2*nk);
   ...
   float *svx1=sf_floatalloc(nxz);
   float *svx2=sf_floatalloc(nxz);
   float *svx3=sf_floatalloc(nxz);
   float *svz1=sf_floatalloc(nxz);
   float *svz2=sf_floatalloc(nxz);
   float *svz3=sf_floatalloc(nxz);
   ...
   for(int it=0;it<ns;it++)
   {
        ...
        fwpvti2delowranksvd(ldataopx1,rdataopx1,fmidopx1,pp,ux,ijkx,ijkz,nx,nz,nxz,nk,m2opx1,n2opx1, kxm, kzm, kxzm, akx, akz);
        for(i=0;i<nxz;i++) ppp[i] = pp[i];
   	    zero1float(pp, nxz);
        //fwpvti2delowrank(ldataopx2,rdataopx2,fmidopx2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2opx2,n2opx2);
		// extrapolation with stability consideration
        fwpvti2delowranksvd(ldataopx2,rdataopx2,fmidopx2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2opx2,n2opx2, kxm, kzm, kxzm, akx, akz);
		...
		// extrapolation with stability consideration
        fwpvti2delowranksvd(ldataopz1,rdataopz1,fmidopz1,pp,ux,ijkx,ijkz,nx,nz,nxz,nk,m2opz1,n2opz1, kxm, kzm, kxzm, akx, akz);
        for(i=0;i<nxz;i++) ppp[i] = pp[i];
   	    zero1float(pp, nxz);
        //fwpvti2delowrank(ldataopz2,rdataopz2,fmidopz2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2opz2,n2opz2);
		// extrapolation with stability consideration
        fwpvti2delowranksvd(ldataopz2,rdataopz2,fmidopz2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2opz2,n2opz2, kxm, kzm, kxzm, akx, akz);
		...
		// extrapolation with stability consideration
        fwpvti2delowranksvd(ldataosx1,rdataosx1,fmidosx1,pp,ux,ijkx,ijkz,nx,nz,nxz,nk,m2osx1,n2osx1, kxm, kzm, kxzm, akx, akz);
        for(i=0;i<nxz;i++) ppp[i] = pp[i];
   	    zero1float(pp, nxz);
        //fwpvti2delowrank(ldataosx2,rdataosx2,fmidosx2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2osx2,n2osx2);
		// extrapolation with stability consideration
        fwpvti2delowranksvd(ldataosx2,rdataosx2,fmidosx2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2osx2,n2osx2, kxm, kzm, kxzm, akx, akz);
		...
		// extrapolation with stability consideration
        fwpvti2delowranksvd(ldataosz1,rdataosz1,fmidosz1,pp,ux,ijkx,ijkz,nx,nz,nxz,nk,m2osz1,n2osz1, kxm, kzm, kxzm, akx, akz);
        for(i=0;i<nxz;i++) ppp[i] = pp[i];
   	    zero1float(pp, nxz);
        //fwpvti2delowrank(ldataosz2,rdataosz2,fmidosz2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2osz2,n2osz2);
		// extrapolation with stability consideration
        fwpvti2delowranksvd(ldataosz2,rdataosz2,fmidosz2,pp,uz,ijkx,ijkz,nx,nz,nxz,nk,m2osz2,n2osz2, kxm, kzm, kxzm, akx, akz);
   ...
   sf_warning("CPU time for every time extrapolation(including low-rank decomp.).: %f(second)",timespent);
