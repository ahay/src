...
int main(int argc, char* argv[])
{
	...
	theta=sf_floatalloc2(nz,nx);	
	   ...
	   apvzz=sf_floatalloc2(nkz, nkx);
           ...
           puthead2(Fo12, nkz, nkx, dz/1000.0, 0.0, dx/1000.0, 0.0);
           puthead2(Fo13, nkz, nkx, dz/1000.0, 0.0, dx/1000.0, 0.0);
           puthead2(Fo14, nkz, nkx, dz/1000.0, 0.0, dx/1000.0, 0.0);
           puthead2(Fo15, nkz, nkx, dz/1000.0, 0.0, dx/1000.0, 0.0);
          ...
          for(ix=0,ixf=0;ix<nx;ix+=nstep,ixf++)
           {
	        ...
	        the=theta[ix][iz];
   	        ...
   	        /*************calculate projection deviation without tapering **********/
                ...
                divpoldevttip(adx,adz,apx,apz,apvx,apvz,kx,kz,kkx,kkz,taper,hnkx,hnkz,dkx,dkz,
      ...
      if(isep==1)
      {
        ...
        puthead3(Fo16, nz, nx, 1, dz/1000.0, dx/1000.0, dt, fz/1000.0, fx/1000.0, 0.0);
      }
