...
/*< fwportpseudop: forward-propagating in ORT media with pseudo-pure P-wave equation>*/
{
    ...
    double vp2,vs2;
    //double cos_alpha,sin_alpha,cos_theta,sin_theta,cos_phi,sin_phi;
...
#pragma omp parallel for private(i,j,k,l, \
     vp2,tmp,vs2,ep_1,ep_2,de_1,de_2,de_3,ga_1,ga_2, \
     vpz,vpx,vpy,vpn1,vpn2,vpn3,vsz1,vsz2,vsz3, \
     C23_44,C12_66,C13_55, \
