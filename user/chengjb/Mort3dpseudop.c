...
{
    int   isx,isy,isz,isxm,isym,iszm;
    ...
    int   A=1;           // the amplitude of wavelet 
 ...
 * ***************************************************************************/
	...
	{
	     t=it*dt;
	     p2[isym][isxm][iszm]+=Ricker(t, f0, t0, A);
	     q2[isym][isxm][iszm]+=Ricker(t, f0, t0, A);
	     r2[isym][isxm][iszm]+=Ricker(t, f0, t0, A);
             //sf_warning("source: p2=%f q2=%f r2=%f",p2[isym][isxm][iszm],q2[isym][isxm][iszm],r2[isym][isxm][iszm]);

  	     fwportpseudop(dt2,p1,p2,p3,q1,q2,q3,r1,r2,r3,
...
/*
           int inc=1;
           cblas_scopy(nxyz, p2, inc, p1, inc);
           cblas_scopy(nxyz, p3, inc, p2, inc);
           cblas_scopy(nxyz, q2, inc, q1, inc);
           cblas_scopy(nxyz, q3, inc, q2, inc);
           cblas_scopy(nxyz, r2, inc, r1, inc);
           cblas_scopy(nxyz, r3, inc, r2, inc);
*/
