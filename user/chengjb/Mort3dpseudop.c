...
int main(int  argc,char **argv)
{
	...
	float*** p1=sf_floatalloc3(nzpad,nxpad,nypad);
        ...
        //puthead3x(Fo1, nz, nx, 1, dz/1000.0, dx/1000.0, dy/1000.0, 0.0, 0.0, 0.0);
        //puthead3x(Fo2, nz, nx, 1, dz/1000.0, dx/1000.0, dy/1000.0, 0.0, 0.0, 0.0);
        //puthead3x(Fo3, nz, nx, 1, dz/1000.0, dx/1000.0, dy/1000.0, 0.0, 0.0, 0.0);
 ...
 * ***************************************************************************/
	...
	for(it=0;it<ns;it++)
	{
	     ...
	     r2[isy][isx][isz]+=Ricker(t, f0, t0, A);
  	     ...
  	     //fwportpseudop2(dt2,p1,p2,p3,q1,q2,q3,r1,r2,r3,
             //              coeff_2dx,coeff_2dy,coeff_2dz,coeff_1dx,coeff_1dy,coeff_1dz,
	     //              vp0,vs0,epsi_1,del_1,gama_1,epsi_2,del_2,gama_2,del_3,
             //              nx,ny,nz,nxpad,nypad,nzpad);//for ORT
