/* 1-D internal convolution complex convolution, adjoint is input 
   quivalent to cicai1.c. Needed to construc lower part (dw) of Spitz MCHF */
/*
  Copyright (C) 2010 Politecnico di Miano
...
void cicai1_dw_init(int nb1           /* filter size */, 
...
void cicai1_dw_lop(bool adj, bool add, int nx, int ny, sf_complex* xx, sf_complex* yy)
/*< linear operator >*/
{
