...
void helix_tcaf_init(int nx_in, float *x_in, sf_filter aa_in)
/*< initialize >*/
{
    nx = nx_in;
	x = x_in;
...
void helix_tcaf_lop(bool adj, bool add, int na, int ny, float *a, float *y)
/*< linear operator >*/
{
    int  ia, ix, iy;
    
    if (ny < nx+na-1) sf_error("%s: Wrong data dimensions",__FILE__);
