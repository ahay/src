/* 3-D dip estimation by plane wave destruction with forward and backward space derivative calculation. 
...
int main (int argc, char *argv[])
{
	...
	if (1 != n4) {
	    ...
	    /* estimate t-x dip */
	    dip3_fb(false, 1, niter, order, nj1, drift, u, p, mm[0], pmin, pmax);
	...
	if (0 != n4) {
	    ...
	    /* estimate t-y dip */
	    dip3_fb(false, 2, niter, order, nj2, drift, u, p, mm[1], qmin, qmax);
	...
	if (1 != n4) {
	    ...
	    /* estimate t-x dip */
	    dip3_fb(true, 1, niter, order, nj1, drift, u, p, mm[2], -pmax, -pmin);
	...
	if (0 != n4) {
	    ...
	    /* estimate t-y dip */
	    dip3_fb(true, 2, niter, order, nj2, drift, u, p, mm[3], -qmax, -qmin);
