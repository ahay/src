/* 3-D robust dip estimation by plane wave destruction with non-stationary smoothing. 
The output is dimensionless (stepout in time measured in time samples). 
also see sfdip
*/
/*
  Copyright (C) 2020 Zhejiang University and University of Texas at Austin
...
int main (int argc, char *argv[])
{
	...
	if (1 != n4) {
	    ...
	    /* estimate t-x dip */
	    dip3n(false, 1, niter, order, nj1, drift, u, p, mm[0], pmin, pmax);
	...
	if (0 != n4) {
	    ...
	    /* estimate t-y dip */
	    dip3n(false, 2, niter, order, nj2, drift, u, p, mm[1], qmin, qmax);
	...
	if (1 != n4) {
	    ...
	    /* estimate t-x dip */
	    dip3n(true, 1, niter, order, nj1, drift, u, p, mm[2], -pmax, -pmin);
	...
	if (0 != n4) {
	    ...
	    /* estimate t-y dip */
	    dip3n(true, 2, niter, order, nj2, drift, u, p, mm[3], -qmax, -qmin);
