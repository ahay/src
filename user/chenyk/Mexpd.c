/* Expand 2D data corret version with true spatial cooridinates  */
/*
...
int expdb(float **vexpmodel, float **vmodel, int vnx, int vnz/*orignal size*/, int vl, int vr, int vt, int vb)
/*<expand model>*/
{
    int ix, iz;
...
int expdbc(float **vexpmodel, float **vmodel, int vnx, int vnz, int vbcout)
/*<expd model for PML bandery condition>*/
{
    expdb(vexpmodel, vmodel, vnx, vnz, vbcout, vbcout, vbcout, vbcout);
    return 1;
}
...
int main(int argc, char* argv[])
{
    ...
    expdb(exmodel, origmodel, nx, nz, left, right, top, bottom);
