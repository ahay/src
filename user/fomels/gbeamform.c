...
void gbeamform_init(int m1, int m2 /* data dimensions */, 
...
/*< initialize >*/
{
    ...
    sf_triangle2_init(1,rect,n1,n2,repeat);
}

void gbeamform_close(void)
...
void gbeamform_lop(bool adj, bool add, int nc, int nd, float* c, float* d)
/*< linear operator >*/
{
    int i1, ic, id;
