...
void fastdip_init(int m1, int m2 /* data dimensions */)
/*< initialize >*/
{
    n1 = m1;
    n2 = m2;
...
void fastdip(float **slice   /* [n2][n1] input data slice */,
...
/*< compute numerator and denominator for division >*/
{
	...
	for (i1=1; i1 < n1-1; i1++) {
	    ...
	    quadratic(2.0*(an-a[i1]),1.5*(bn+b[i1]),2.0*(cn-c[i1]),numer[i2-1]+i1,denom[i2-1]+i1);
