...
{
    bool adj;
    int n1, nc, nd, n3, i3, nb, n1c, n1d, repeat;
    ...
    gbeamform_init(n1, nd, nb, repeat);
	...
	gbeamform_lop(adj,false,n1c,n1d,coarse,dense);
