...
/*
  ...
  This file contains the GPU kernel functions called in the ewefd3d_gpu_p2p_dev module from
...
/*
 * function sf_floatreadtransp:
 * read in x*y*z float values from file in and transpose z and x axes
 *
 * NOTE: axes from slowest to fastest in file in are y,x,z.
 * NOTE: axes from slowest to fastest in output array out are y,z,x.
 *
 * Input:
 *      in		- the file to read values from
 *		x, y, z	- dimensions of data to be read	
 *
 * Output:
 *      out		- array containing transposed data from file in
 *
 * Return:
 * 		void
 */
