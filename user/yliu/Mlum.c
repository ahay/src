...
int main (int argc, char* argv[]) 
{
    ...
    if(smnclip<1 || smnclip>((nfw+1)/2)) sf_error("Smnclip need a value between 0 and (nfw+1)/2");
    if(shnclip<1 || shnclip>((nfw+1)/2)) sf_error("Shnclip need a value between 0 and (nfw+1)/2");
