/* Taper shot gathers with a trapezoidal filter along the first axis */
/*
...
int main(int argc, char *argv[])
{
	...
	Fdat=sf_input("in");
	Fnew=sf_output("out");
	if(!sf_getint("length", &range)) range=15; /* tapering length */
