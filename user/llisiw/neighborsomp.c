/* Inner part of fast marching (OMP) */
/*
...
int neighbors_surface(float* vv1  /* slowness [n[0]*n[1]*n[2]] */,
...
int neighbors_mask(float* vv1  /* slowness [n[0]*n[1]*n[2]] */,
