  ...
  >*/
{
    ...
    v = slow2(par, x);
    M[0][0] = sf_cmplx(0.,sqrtf(v));
    M[0][1] = sf_cmplx(0.,0.);
    M[1][0] = sf_cmplx(0.,0.);
    M[1][1] = sf_cmplx(0.,sqrtf(v));
    N[0][0] = sf_cmplx(shift,0.);
    N[0][1] = sf_cmplx(0.,0.);
    N[1][0] = sf_cmplx(0.,0.);
    N[1][1] = sf_cmplx(shift,0.);
	...
	if (dynaM != NULL) {
	    dynaM[it+1][0][0] = M[0][0];
	    dynaM[it+1][0][1] = M[0][1];
	    dynaM[it+1][1][0] = M[1][0];
	    dynaM[it+1][1][1] = M[1][1];
	}
	if (dynaN != NULL) {
	    dynaN[it+1][0][0] = N[0][0];
	    dynaN[it+1][0][1] = N[0][1];
	    dynaN[it+1][1][0] = N[1][0];
	    dynaN[it+1][1][1] = N[1][1];
	}
...
/* 	$Id: atela.c 7107 2011-04-10 02:04:14Z ivlad $	 */
