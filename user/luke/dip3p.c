...
void dip3p_init(int m1, int m2, int m3 /* dimensions */, 
...
/*< initialize >*/
{
    ...
    sf_divnp_init (3, n, nn, rect, niter, verb);
}

void dip3p_close(void)
...
void dip3p(bool left               /* left or right prediction */,
