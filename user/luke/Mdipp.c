...
int main (int argc, char *argv[])
{
    ...
    dip3p_init(n[0], n[1], n[2], rect, liter, eps, verb);
...
#pragma omp parallel for
	    ...
	    /* estimate t-x dip */
	    dip3p(false, 1, niter, order, nj1, u, p, mm[0], pmin, pmax);
	...
	if (0 != n4) {
	    ...
	    /* estimate t-y dip */
	    dip3p(false, 2, niter, order, nj2, u, p, mm[1], qmin, qmax);
	...
	if (1 != n4) {
	    ...
	    /* estimate t-x dip */
	    dip3p(true, 1, niter, order, nj1, u, p, mm[2], -pmax, -pmin);
...
#pragma omp parallel for
	    ...
	    /* estimate t-y dip */
	    dip3p(true, 2, niter, order, nj2, u, p, mm[3], -qmax, -qmin);
