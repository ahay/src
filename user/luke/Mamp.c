/* Local mean amplitude Determination for an array of arbitrary dimension.  The initial value of a unit is used for indicies falling  between within the edge and the sampling length for each dimension.
*/
/*
...
//                   sf_warning("call %i",call);
                   ...
                   holder += anal; //add the square of the analysis number
...
//                           sf_warning("holder %g",holder); 
             ...
             attr[0]=data[i];//call edge effect regions their initial value.
