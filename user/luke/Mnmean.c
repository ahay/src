/* Local sliding mean value Determination for an array of arbitrary dimension.  The value of a unit is used for indicies falling  between within the edge and the sampling length for each dimension.
*/
/*
...
//--ooO-(_)-Ooo--------------------
              ...
              for (k=0; k < indexalloc1; k++){
                   ...
                   holder += anal; //add the analysis number
