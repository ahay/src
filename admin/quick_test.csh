...
echo
sfbooklist size=1024 public=n list=filter skipfile=skiplist.txt book

# run the examples
echo "+++++++ Running examples +++++++"
echo
sfbooklist size=1024 public=n list=filter skipfile=skiplist.txt timer=file \
...
echo
rm book/*/*/*/.rsftest
sfbooklist size=1024 public=n list=filter skipfile=skiplist.txt \
