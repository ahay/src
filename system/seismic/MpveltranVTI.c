...
int main (int argc, char* argv[])
{
    ...
    if (inter) {
	if (NULL != sf_getstring("dipt")) dipt = sf_input("dipt"); /*time derivative of slope field*/
	else sf_error("Need dipt field=");
        
	if (NULL != sf_getstring("curvt")) curvt = sf_input("curvt"); /*time derivative of slope field*/
