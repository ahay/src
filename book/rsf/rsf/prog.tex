...
input files.
\moddex{add}{add}{412}{450}{system/main}
...
data type.  
\moddex{add}{add}{173}{194}{system/main}

The data combination program for floating point numbers is
\texttt{add\_float}.  
\moddex{add}{add}{253}{294}{system/main}
...
\moddex{attr}{attr}{80}{83}{system/main}

In the main loop, we read the input data buffer by buffer.
\moddex{attr}{attr}{97}{116}{system/main}

The data attributes are accumulated in corresponding double-precision
variables. 
\moddex{attr}{attr}{137}{138}{system/main}

Finally, the attributes are reduced and printed out.
\moddex{attr}{attr}{170}{177}{system/main}
\moddex{attr}{attr}{184}{193}{system/main}
...
The first input file is either in the list or in the standard input.
\moddex{cat}{cat}{48}{55}{system/main}
...
\moddex{cat}{cat}{57}{63}{system/main}
...
\moddex{cat}{cat}{67}{80}{system/main}
...
\moddex{cat}{cat}{94}{99}{system/main}

In the output, the selected axis will get extended.
\moddex{cat}{cat}{111}{125}{system/main}
...
\texttt{space=y}.
\moddex{cat}{cat}{134}{149}{system/main}
...
\moddex{cmplx}{cmplx}{39}{55}{system/main}
...
\moddex{cmplx}{cmplx}{79}{88}{system/main}
