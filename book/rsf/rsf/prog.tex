...
\moddex{add}{add}{101}{108}{user/main}
...
data type.  
\moddex{add}{add}{173}{194}{user/main}

The data combination program for floating point numbers is
\texttt{add\_float}.  
\moddex{add}{add}{253}{294}{user/main}
...
The first input file is either in the list or in the standard input.
\moddex{cat}{cat}{48}{55}{user/main}
...
\moddex{cat}{cat}{57}{63}{user/main}
...
\moddex{cat}{cat}{67}{80}{user/main}
...
\moddex{cat}{cat}{94}{99}{user/main}

In the output, the selected axis will get extended.
\moddex{cat}{cat}{111}{125}{user/main}
...
\texttt{space=y}.
\moddex{cat}{cat}{134}{149}{user/main}
...
\moddex{cmplx}{cmplx}{39}{55}{user/main}
...
\moddex{cmplx}{cmplx}{79}{88}{user/main}
...
\subsubsection{Implementation: \href{http://rsf.svn.sourceforge.net/viewvc/rsf/trunk/user/main/conjgrad.c?view=markup}{user/main/conjgrad.c}}
