...
$\frac{1}{n-1}\,\left[\sum\limits_{i=0}^n d_i^2 -
\frac{1}{n}\left(\sum\limits_{i=0}^n d_i\right)^2\right]$, and the standard
...
are reported unleass they are identically zero.  This quick inspection
