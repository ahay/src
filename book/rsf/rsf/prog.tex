...
\href{http://rsf.svn.sourceforge.net/viewvc/rsf/trunk/filt/main/}{filt/main}
...
\subsubsection{Implementation: \href{http://rsf.svn.sourceforge.net/viewvc/rsf/trunk/filt/main/add.c?view=markup}{filt/main/add.c}}
...
\subsubsection{Implementation: \href{http://rsf.svn.sourceforge.net/viewvc/rsf/trunk/filt/main/attr.c?view=markup}{filt/main/attr.c}}

Computations start by finding the input data (\texttt{in}) size
(\texttt{nsiz}) and dimensions (\texttt{dim}).
\moddex{attr}{attr}{78}{81}{filt/main}

In the main loop, we read the input data buffer by buffer.
\moddex{attr}{attr}{95}{114}{filt/main}

The data attributes are accumulated in corresponding double-precision
variables. 
\moddex{attr}{attr}{135}{136}{filt/main}

Finally, the attributes are reduced and printed out.
\moddex{attr}{attr}{168}{175}{filt/main}
\moddex{attr}{attr}{182}{191}{filt/main}
...
\subsubsection{Implementation: \href{http://rsf.svn.sourceforge.net/viewvc/rsf/trunk/filt/main/cat.c?view=markup}{filt/main/cat.c}}

The first input file is either in the list or in the standard input.
\moddex{cat}{cat}{48}{55}{filt/main}
...
\moddex{cat}{cat}{57}{63}{filt/main}
...
\moddex{cat}{cat}{67}{80}{filt/main}
...
\moddex{cat}{cat}{94}{99}{filt/main}

In the output, the selected axis will get extended.
\moddex{cat}{cat}{111}{125}{filt/main}
...
\texttt{space=y}.
\moddex{cat}{cat}{134}{149}{filt/main}
