...
\moddex{add}{add}{101}{108}{system/main}
...
\moddex{add}{add}{110}{116}{system/main}

A helper function \texttt{check\_compat} checks the compatibility of
input files.
\moddex{add}{add}{422}{461}{system/main}
...
data type.  
\moddex{add}{add}{182}{203}{system/main}

The data combination program for floating point numbers is
\texttt{add\_float}.  
\moddex{add}{add}{263}{304}{system/main}
...
\moddex{attr}{attr}{98}{120}{system/main}

The data attributes are accumulated in corresponding double-precision
variables. 
\moddex{attr}{attr}{144}{145}{system/main}

Finally, the attributes are reduced and printed out.
\moddex{attr}{attr}{178}{185}{system/main}
\moddex{attr}{attr}{192}{201}{system/main}
...
The first input file is either in the list or in the standard input.
\moddex{cat}{cat}{49}{56}{system/main}
...
\moddex{cat}{cat}{58}{64}{system/main}
...
\moddex{cat}{cat}{76}{89}{system/main}
...
\moddex{cat}{cat}{103}{108}{system/main}

In the output, the selected axis will get extended.
\moddex{cat}{cat}{120}{134}{system/main}
...
\texttt{space=y}.
\moddex{cat}{cat}{155}{170}{system/main}
