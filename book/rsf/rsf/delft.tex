...
\title[E\"{o}tv\"{o}s Lor\'{a}nd Geofizikai Int\'{e}zetnek]{Reproducible Computations  Using \\ \textsc{Madagascar} Software Package}
...
\institute[School on Reproducible Computational Geophysics] % (optional, aber oft nötig)
{
  Jackson School of Geosciences \\
  The University of Texas at Austin
}

\date{\today} %June 12, 2009}
