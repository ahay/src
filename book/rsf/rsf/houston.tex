...
\institute[Madagascar School and Hands-On Workshop] % (optional, aber oft nötig)
{
...
\begin{frame}
 ...
 {\color{blue}{\textbf{\url{http://m8r.info/}}}} 
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Use \texttt{svn} (Subversion) to download {\color{blue}{\href{http://rsf.svn.sourceforge.net/viewvc/rsf/trunk/}{unstable}}} (current
      development) release
      \begin{itemize}
