...
\institute[UT Austin] % (optional, aber oft nötig)
{
...
\begin{frame}
  ...
  \item {\color{blue}{\href{http://egl.beg.utexas.edu/rsflog/}{Blog}}}
  \begin{itemize}
\item {\color{blue}{\href{http://egl.beg.utexas.edu/rsflog/index.php?/feeds/index.rss2}{RSS subscription}}} 
\end{itemize}
  \item {\color{blue}{\href{http://rsf.sourceforge.net/}{Wiki}}}
  \end{itemize}
\end{frame}
