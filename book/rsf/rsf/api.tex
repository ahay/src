...
in \\ \texttt{\$RSFROOT/etc/madagascar/config.py}.
...
uses are in \\ \texttt{\$RSFROOT/etc/madagascar/config.py}.
...
\section{MATLAB interface} % a meaningless comment
...
parameters are stored in \\ \texttt{\$RSFROOT/etc/madagascar/config.py}.
