...
\begin{frame}
%\frametitle{First Paper in Geophysics}
\begin{center}
\vfill
...
\vfill
\begin{beamercolorbox}[wd=\textwidth,center]{quotecol}
\Large \color{blue}{\textbf{Reproducibility is not the goal.}}
\end{beamercolorbox}
\vfill
...
\begin{frame}
%\MadLogo
\frametitle{Science versus Open-Source Software}
...
\begin{itemize}
\item The Digitization of Science: {\color{blue}{\textbf{ Reproducibility}}} and Interdisciplinary Knowledge Transfer at AAAS 2011
\item Verifiable, {\color{blue}{\textbf{ Reproducible Research}}} and Computational Science at SIAM CS\&E 2011
\item {\color{blue}{\textbf{Reproducible Science}}} and Open-Source Software
in the Geosciences at SIAM Geosciences 2011
\item {\color{blue}{\textbf{ Reproducible Research}}} at Interface 2011
\item {\color{blue}{\textbf{ Reproducible Research}}}: Tools and
  Strategies for Scientific Computing at AMP 2011
\begin{itemize}
\item CiSE July-August 2012
\end{itemize}
\item {\color{blue}{\textbf{Reproducible Research}}} in Computational Science: What, Why, and How at
ICIAM 2011
\item Publishing {\color{blue}{\textbf{Reproducible Science}}} and Software at SIAM Imaging Science
2012
\end{itemize}
...
\begin{frame}
  ...
  \includegraphics[width=\textwidth]{Fig/RSF2011}
\end{frame}
