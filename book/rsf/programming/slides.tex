...
\lstinputlisting[language=Python,firstline=1,lastline=5,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}

\begin{frame} \frametitle{API import}
\lstinputlisting[language=Python,firstline=6,lastline=14,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}

\begin{frame} \frametitle{Initialize command line argument parser}
\lstinputlisting[language=Python,firstline=17,lastline=18,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}
...
\lstinputlisting[language=Python,firstline=19,lastline=22,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}
...
\lstinputlisting[language=Python,firstline=23,lastline=25,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}

\begin{frame} \frametitle{Read input headers}
\lstinputlisting[language=Python,firstline=31,lastline=33,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}

\begin{frame} \frametitle{Read datasets}
\lstinputlisting[language=Python,firstline=35,lastline=38,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}

\begin{frame} \frametitle{Perform SVD}
\lstinputlisting[language=Python,firstline=40,lastline=41,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}
...
\lstinputlisting[language=Python,firstline=47,lastline=48,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}

\begin{frame} \frametitle{Close open files}
\lstinputlisting[language=Python,firstline=60,lastline=62,frame=shadowbox]{samples/python/Msvd.py}
\end{frame}
