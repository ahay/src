...
%
In \rEq{AWE},
$\UU\ofxt$ represents the acoustic wavefield,
$v\ofx$ and $\rho\ofx$ represent the velocity and density of the
medium, respectively, and $f\ofxt$ represents a source function.
\begin{itemize}
...
velocity model is illustrated in \rFg{velo}. The model is
