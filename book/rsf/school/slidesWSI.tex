...
% ------------------------------------------------------------
\begin{frame} \big{\texttt{scons dens.view}} \end{frame}
...
% ------------------------------------------------------------
\begin{frame} 
\big{\texttt{scons vstr.view}} 
\big{\texttt{scons vsmo.view}} 
\end{frame}
...
% ------------------------------------------------------------
\begin{frame} \big{\texttt{scons wav.view}} \end{frame}
...
% ------------------------------------------------------------
\begin{frame} 
\big{\texttt{scons datH.view}} 
\big{\texttt{scons wigH.view}}
\end{frame}
...
% ------------------------------------------------------------
\begin{frame} 
\big{\texttt{scons datV.view}} 
\big{\texttt{scons wigV.view}}
\end{frame}
...
\begin{frame} \frametitle{run FD migration}
  \normalsize
  \blueshade{
    \lstinputlisting[firstline=186,lastline=186]{sigsbee/SConstruct}
    \lstinputlisting[firstline=187,lastline=194]{sigsbee/SConstruct}
  }
\end{frame}
\cwpnote{}
...
\begin{frame} \frametitle{plot the image}
  ...
  \blueshade{
    \lstinputlisting[firstline=186,lastline=186]{sigsbee/SConstruct}
    \lstinputlisting[firstline=195,lastline=200]{sigsbee/SConstruct}
  }
\end{frame}
\cwpnote{}

\begin{frame} 
\big{\texttt{scons imgH.view}} 
\big{\texttt{scons imgV.view}}
\big{\texttt{scons imgA.view}}
\end{frame}
