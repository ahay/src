...
\multiplot{4}{cmp,signal2,vscan_cmp,vscan_signal2}{width=.39\textwidth}{CMP gather before multiple attenuation (a). CMP gather after multiple attenuation (b). Gather in (a) is used to generated Semblance scan (c). Gather in (b) is used to generate Semblance scan (d).}
