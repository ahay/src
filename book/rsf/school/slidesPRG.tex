...
\begin{frame}[fragile] \frametitle{demo}
  ...
  \mex{ {\bf sfspike} \\
    \emph{n1=100 o1=0 d1=0.01 n2=50 o2=1000 d2=10} \\
    $>$ file1.rsf }
  
  \vfill
  \begin{itemize}
  \item standard in: none
  \item standart out: \mex{file1.rsf}
  \end{itemize}
...
\begin{frame} \frametitle{compatibility}
  ...
  \item SU: use converters
    \\
    \mex{ {\bf sfsegyread}  tape=file1.su su=y tfile=tfile.rsf endian=0 $>$ file1.rsf }
    \vspace{0.25in}
    \\
    \mex{ {\bf sfsegywrite} tape=file1.su su=y tfile=tfile.rsf endian=0 $<$ file1.rsf }
  \end{itemize}
\end{frame}
\cwpnote{}
...
\begin{frame}[fragile] \frametitle{demo}
  ...
  \mex{ $<$ file1.rsf {\bf sfwindow} n2=25 min2=1200 $>$ file2.rsf}
  \vfill
  \mex{ {\bf sfin} file1.rsf}
  \tiny
\begin{semiverbatim}
...
\begin{frame}[fragile] \frametitle{demo}
  ...
  \mex{ $<$ file1.rsf {\bf sfwindow} n2=25 min2=1200 $|$ {\bf sftransp} $>$ file3.rsf}
...
\normalsize
  ...
  \mex{ $<$ sin1.rsf sfgraph title=''1D plot'' $|$ xtpen}
...
\normalsize
  ...
  \mex{ $<$ sin2.rsf sfgrey title=''2D plot'' $|$ xtpen}
\end{frame}
\cwpnote{}
...
\begin{frame}[fragile] \frametitle{exercise (1)}
  \framesubtitle{create 2D Gaussian function}
  ...
  \mex{
    $<$ gg.rsf sfgrey pclip=100 screenratio=1 title="2D Gaussian" $|$ \\
    xtpen
  }
...
% ------------------------------------------------------------
\begin{frame}
  \plot{gg}{width=0.75\textwidth}{}
\end{frame}
\cwpnote{}

% ------------------------------------------------------------
\begin{frame}[fragile] \frametitle{exercise (2)}
  \framesubtitle{extract 1D subset from the 2D Gaussian function}
  
  \mex{
    $<$ gg.rsf sfwindow n2=1 f2=100 $|$ \\
    sfgraph title="1D Gaussian" $|$ \\
    xtpen
  }
...
% ------------------------------------------------------------
\begin{frame}
  \plot{gg0}{width=0.75\textwidth}{}
\end{frame}
\cwpnote{}

% ------------------------------------------------------------
\begin{frame}[fragile] \frametitle{exercise (3)}
  \framesubtitle{create a velocity model}
  
  \mex{
    $<$ gg.rsf sfscale rscale=-1. $|$ \\
    sfadd add=3 $>$ vel.rsf
  }
  ...
  \mex{
    $<$ vel.rsf sfgrey title="" pclip=100 screenratio=1 bias=3 $|$ \\
    xtpen
  }
...
\begin{frame}[fragile] \frametitle{exercise (4)}
  \framesubtitle{compute traveltimes with an eikonal solver}
  ...
  \mex{
    $<$ fme.rsf sfcontour title="" nc=200 screenratio=1 $|$ \\
    xtpen
  }
...
% ------------------------------------------------------------
\begin{frame}
  \plot{fme}{width=0.75\textwidth}{}
\end{frame}
\cwpnote{}

% ------------------------------------------------------------
\begin{frame}[fragile] \frametitle{exercise (5)}
  \framesubtitle{compute rays and wavefronts}
  
  \mex{
    $<$ vel.rsf sfhwt2d xsou=0 zsou=-10 nt=1000 ot=0 dt=0.01 ng=1801 og=-90 dg=0.1 $>$ hwt.rsf
  }
