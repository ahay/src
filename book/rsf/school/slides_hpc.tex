...
\begin{frame}
    \plot{moore_law}{width=0.95\textwidth}{ \klabellarge{35}{19}{\footnotesize  http://en.wikipedia.org/wiki/Moore\%27s\_law}}
\end{frame}


\begin{frame}
    \plot{AmdahlsLaw}{width=.8\textwidth}{ \klabellarge{5}{-8}{\small http://en.wikipedia.org/wiki/Amdahl\%27s\_law}}
\end{frame}
...
\begin{frame} 
\plot{shared}{width=0.7\textwidth}{ \klabellarge{17}{-10}{shared memory system}}
\end{frame}
\begin{frame}
\plot{distributed}{width=0.7\textwidth}{ \klabellarge{2}{-10}{distributed memory system}}
\end{frame}
...
\itab{\bf{resources:}}
\vfill
\itab{\itab{http://openmp.org/wp/}}
\vfill
\itab{\itab{http://www.cOMPunity.org/}}
\end{frame}
...
\itab{\bf{resources:}}
\vfill
\itab{\itab{ http://www.open-mpi.org/software/}}
\vfill 
\end{frame}
...
Flow('clip_hybrid','random clip_omp.exe',
    './${SOURCES[1]} clip=500',split=[3,'mpi',4],reduce='cat')
\end{python}
...
\itab{http://reproducibility.org/wiki/Parallel\_Computing}
\vfill
\itab{Vladimir Bashkardin's, Houston 2010 presentation: \small http://reproducibility.org/wikilocal/docs/Houston2010\_HPC.pdf}
\vfill
\itab{Dave Hale's, Houston 2011 presentation: \small http://www.beg.utexas.edu/pttc/2011/2011\_pres\_01\_03\_hale.pdf}
\vfill
\end{frame}
