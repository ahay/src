...
\plot{panel1}{height=0.5\textheight}{Top left: original image. Top  right: random noise added. Bottom left: original image spectrum in the Fourier ($F$-$X$) domain. Bottom right: noisy image spectrum in the Fourier ($F$-$X$) domain.}

\plot{panel2}{height=0.25\textheight}{Left: denoising by low-pass filtering.  Right: denoising by hard thresholding in the Fourier domain.}
