...
\cite[]{bioconductor}, geoinformatics \cite[]{geo}, and computational
...
\plot{panel1}{height=0.5\textheight}{Top left: original image. Top
  right: random noise added. Bottom left: original image spectrum in
...
\plot{panel2}{height=0.25\textheight}{Left: denoising by low-pass filtering.
  Right: denoising by hard thresholding in the Fourier domain.}
...
\tabl{texcom}{Basic methods of an \texttt{rsftex} object.}{
\begin{center}
\begin{tabular}{|p{0.9\textwidth}|} \hline
  ...
  \href{http://rsf.sourceforge.net/wiki/index.php/Segtex}{SEGTeX}
...
\tabl{tex}{SCons commands defined in \texttt{rsftex}.}{
\begin{center}
\begin{tabular}{|p{0.9\textwidth}|}
  \hline 
  \noindent\texttt{scons}\\ \ \\
...
\lstinputlisting[firstline=452,lastline=454,frame=single]{paper.tex}
