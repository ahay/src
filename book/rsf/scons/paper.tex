...
\lstinputlisting[firstline=1,lastline=21,frame=single]{easystart/SConstruct}
...
\end{verbatim}
%
with login: anonymous and password: anonymous.
%
\begin{verbatim}
bash$ cd data/imgs
bash$ get lena.img
...
\begin{verbatim}
bash$ < flena.rsf sfwindow f2=1 > flena512.rsf
\end{verbatim}

\lstinputlisting[firstline=12,lastline=13,frame=single]{easystart/SConstruct}

\begin{verbatim}
bash$ < flena512.rsf sfmath output="input-99.0512" > zmflena512.rsf
\end{verbatim}
...
maxval=150 clip=120 screenratio=1 titlesz=14 > Fig/zmflena512.vpl
\end{verbatim}

\lstinputlisting[firstline=21,lastline=21,frame=single]{easystart/SConstruct}

\subsection{RSF combined with Python example}
