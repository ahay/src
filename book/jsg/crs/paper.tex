...
\plot{circle}{height=0.8\textheight}{Relative error in prediction of
  reflection traveltime in the case of a circular reflector in a
  homogeneous medium using different approximations: (a)
  multifocusing, (b) CRS, (c) non-hyperbolic CRS. The model parameters
  are $m=R=D$ (see Figure~\ref{fig:crefl}.)}
