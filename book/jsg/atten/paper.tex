...
\shortcite{Wu_82,Wu_A85}, is the restriction of the validity of the mean field formalism to low frequency.
...
O'Doherty and Anstey \shortcite{Odoherty_A71} to introduce the fundamental concept
...
The fractal property of subsurface heterogeneities was initially discussed by Hewett \shortcite{Hewett_86} 
...
Gist \shortcite{Gist_94} tried to explain seismic-wave attenuation in VSP surveys 
...
as proposed by O'Doherty and Anstey \shortcite{Odoherty_A71} and Anstey and O'Doherty \shortcite{Anstey_D02a}.
...
This function was initially derived by von K\'arm\'an \shortcite{Vonkarman_48} 
...
The Fourier transform of $N_{H,b}(\mathbf{r})$ was given by Lord \shortcite{Lord_54}.
...
by Walden and Hosken \shortcite{Walden_H85} shows $1/2 \leq \beta \leq 3/2$, promoting the so-called $1/f$ geology.
...
is $E(f)\propto 1/f$.
Klime\u{s} \shortcite{Klimes_02} in fact proposed using $-0.5\leq H\leq 0$ to synthesize geologically realistic 2D models
...
O'Doherty and Anstey \shortcite{Odoherty_A71} and Anstey and O'Doherty \shortcite{Anstey_D02a} 
...
Acccording to Anstey and O'Doherty \shortcite{Anstey_D02a},
...
White et al.~\shortcite{White_SN90} suggested the possibility of superposition of two correlation lengths at 5 and 20~m.
...
We refer the reader to Stovas and Ursin \shortcite{Stovas_U07} for more information
...
Our analysis is limited by the fact that we used variations of the seismic velocity, 
...
was succesfully achieved by Banik et al. \shortcite{Banik_LS85}, and they provided a proof of O'Doherty-Anstey formula.
...
%\renewcommand{\figdir}{WFig} % figure directory
...
and the effective medium theory of Backus \shortcite{Backus_62}\,:
\begin{eqnarray}
