...
\begin{figure}[htb!]
  \centering
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/field-1-0}
    \label{fig:field-1-0}}
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/dif-1-0}
    \label{fig:dif-1-0}}   
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/field-2-0}
    \label{fig:field-2-0}}
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/dif-2-0}
    \label{fig:dif-2-0}}         
...
\begin{figure}[htb!]
  \centering
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/field-ortho-0}
    \label{fig:field-ortho-0}}
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/dif-ortho-0}
    \label{fig:dif-ortho-0}}   
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/field-3-0}
    \label{fig:field-3-0}}
    \subfigure[]{\includegraphics[width=0.40\columnwidth]{field/Fig/dif-3-0}
    \label{fig:dif-3-0}}         
...
\begin{figure}[htb!]
  \centering
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zooma-1}
    \label{fig:zooma-1}}
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zooma-2}
    \label{fig:zooma-2}}   
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zooma-ortho}
    \label{fig:zooma-ortho}}
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zooma-3}
    \label{fig:zooma-3}}         
...
\begin{figure}[htb!]
  \centering
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zoomb-1}
    \label{fig:zoomb-1}}
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zoomb-2}
    \label{fig:zoomb-2}}   
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zoomb-ortho}
    \label{fig:zoomb-ortho}}
    \subfigure[]{\includegraphics[width=0.35\columnwidth]{field/Fig/zoomb-3}
    \label{fig:zoomb-3}}         
...
\begin{figure}[htb!]
  \centering
    \includegraphics[width=0.8\columnwidth]{field/Fig/field-fs}
