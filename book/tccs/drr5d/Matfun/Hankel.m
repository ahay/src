function Hankel(H_clean,H_obs,H_rr,H_drr,H_rr10,H_drr10)
...
tic
[d3,M_c,M_obs,M_orr,M_orr10]=drr5d_lb_recon_H(d0,d,mask,flow,fhigh,30,dt,N,NN,Niter,eps,verb,mode,2,a);
toc
