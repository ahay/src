...
To represent a realistic situation, we placed the same reflectors and
...
\inputdir{theo}
\plot{theo-model}{width=0.75\columnwidth}{Theoretical model with two plane reflectors and one diffractor.}
\plot{data0}{width=0.75\columnwidth}{Zero-offset section corresponding to the constant-velocity model.}
\plot{zo-res-init}{width=0.75\columnwidth}{Depth-migrated image and common-image-gather in dip-angle domain corresponding to distance of 7~km.}
...
\inputdir{depthMig}
\plot{dm-zo}{width=0.75\columnwidth}{Zero-offset section corresponding to the Marmousi-velocity model.}
\plot{res-init}{width=0.75\columnwidth}{Depth-migrated image and common-image-gather in dip-angle domain corresponding to distance of 7~km.}
...
\plot{res-clean}{width=0.75\columnwidth}{Image and dip-angle gather after migration-aperture optimization by slope-consistency analysis.}
...
\plot{res-clean1}{width=0.75\columnwidth}{Image and dip-angle gather after migration-aperture optimization by local summation in the dip-angle
 direction.}
...
\plot{fres-init}{width=0.75\columnwidth}{Initial image and common-image-gather in dip-angle domain corresponding to distance of 7~km (wrong velocity case).}
\plot{fres-clean}{width=0.75\columnwidth}{Image and dip-angle gather after migration-aperture optimization by slope-consistency analysis (wrong velocity case).}
...
The proposed approach can be used easily in three dimensions, in which migrated events are defined by two orthogonal directions
...
\inputdir{sigsbee1}
\plot{sigs-input}{width=0.75\columnwidth}{Initial image and common-image gather in dip-angle domain corresponding to distance of 6.1 km.}
\plot{sigs-ap}{width=0.75\columnwidth}{Image and dip-angle gather after migration-aperture limiting.}
\plot{sigs-semb}{width=0.75\columnwidth}{Image and dip-angle gather after migration-aperture optimization by slope-consistency analysis.}
...
\plot{init}{width=0.75\columnwidth}{Initial image and common-image gather in dip-angle domain corresponding to distance of~16.8~km.}
\plot{sca}{width=0.75\columnwidth}{Image and dip-angle gather after migration-aperture optimization by slope-consistency analysis.}
\plot{ap}{width=0.75\columnwidth}{Image and dip-angle gather after migration-aperture limiting.}
