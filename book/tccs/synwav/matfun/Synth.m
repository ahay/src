function Synth(data,tfsswt,tfwt,dt,nt,nf)
...
[dtemp1, f, opts]=wt(d, fs,'Display','notify');
...
dtfwt=interp2(t0,f,dtemp1,t1,f1);

rsf_create(tfsswt,size(dtf)');
rsf_write(abs(dtf),tfsswt);

rsf_create(tfwt,size(dtfwt)');
rsf_write(abs(dtfwt),tfwt);
