...
ga =Show[Rasterize[ParametricPlot3D[{groupx,groupy,groupmshappq},{theta,0.1,89.9},{phi,0,360},PlotRange->{Full,Full,All},Axes->{False,False,False},Boxed->False,LabelStyle->{FontWeight->"Bold",FontSize->22},ColorFunction->ColorData[{"DarkRainbow",{0,0.5}}],ViewPoint->{0,0,Infinity},Mesh->None,ColorFunctionScaling->False,PlotPoints->200,ImagePadding->40],Background->None,ImageSize->600],Rasterize[orthogroupplot,Background->None,ImageSize->600]]
