...
ga =Rasterize[ParametricPlot3D[{phasex,phasey,phaseweak},{theta,0,90},{phi,0,90},PlotRange->{Full,Full,All},AxesLabel->{"theta  ","  theta","Relative\nError (%)   "},LabelStyle->{FontWeight->"Bold",FontSize->22},TicksStyle->Directive[Thick,20],PlotLegends->Automatic,ColorFunction->ColorData[{"DarkRainbow",{0,2.0}}],Mesh->10,ColorFunctionScaling->False,BoxRatios->{1,1,1/4},ImageSize->800,ViewAngle->Automatic],RasterSize->4000,ImageSize->600]
