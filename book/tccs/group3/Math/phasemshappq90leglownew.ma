...
ga=Rasterize[ParametricPlot3D[{phasex,phasey,phasemshappq},{theta,0,90},{phi,0,90},PlotRange->{Full,Full,All},AxesLabel->{"theta  ","  theta","Relative\nError (%)    "},LabelStyle->{FontWeight->"Bold",FontSize->22},ColorFunction->ColorData[{"DarkRainbow",{0,0.5}}],TicksStyle->Directive[Thick,20],PlotLegends->Automatic,ViewAngle->Automatic,Mesh->10,ColorFunctionScaling->False,BoxRatios->{1,1,1/4},ImageSize->800],RasterSize->4000,ImageSize->600]
