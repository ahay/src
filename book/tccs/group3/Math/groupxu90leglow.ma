...
ga =Rasterize[ParametricPlot3D[{groupx,groupy,groupxu},{theta,0.1,89.9},{phi,0,90},PlotRange->{Full,Full,Automatic},AxesLabel->{"Theta  ","  Theta","Relative\nError (%)   "},LabelStyle->{FontWeight->"Bold",FontSize->22},ColorFunction->ColorData[{"DarkRainbow",{0,2.5}}],TicksStyle->Directive[Thick,20],ViewAngle->Automatic,Mesh->10,ColorFunctionScaling->False,PlotLegends->Automatic,BoxRatios->{1,1,1/4},ImageSize->800],RasterSize->4000,ImageSize->600]
