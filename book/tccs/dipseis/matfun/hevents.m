function [d,h,t] = yc_hevents(dt,f0,tmax,h,tau,v,amp,snr,L,seed);
%HEVENTS: A program to generate data containing hyperbolas.
%
%  [d] = yc_hevents(dt,f0,tmax,h,tau,v,amp,snr,L);
%
