...
yoffset = (2 dy)/.{Δd1->depth1,Δd2->depth2,Δd3->depth3}/.{p1->maxr Cos[theta],p2->maxr Sin[theta]};//Simplify
exacttime = (2 dt)/.{Δd1->depth1,Δd2->depth2,Δd3->depth3}/.{p1->maxr Cos[theta],p2->maxr Sin[theta]};
...
%exact = (-0.00682305+8.78897*10^-19 I) x1^4-(0.0162965+4.64623*10^-18 I) x1^2 x2^2-(0.00945721-1.61273*10^-18 I) x2^4/.{x1->xoffset,x2->yoffset};
exact = (-0.00682305) x1^4 -(0.0162965) x1^2 x2^2 -(0.00945721) x2^4 /.{x1->xoffset,x2->yoffset};

nonhyper = Rasterize[ParametricPlot3D[{xoffset/depth,yoffset/depth,Re[exacttime^2-orthoell-exact]}/.{p1->maxr Cos[theta],p2->maxr Sin[theta]},{R,0,1},{theta,0,Pi/2},PlotRange->{All,All,All},BoxRatios->{1,1,0.3},AxesLabel->{"x1(km)","x2(km)","E_quar (s^2)          "},ColorFunction->ColorData["DarkRainbow"],PlotPoints->50, LabelStyle->{Black,FontWeight->"Bold",FontSize->24},TicksStyle->Directive[Thick,20],Mesh->9,ImageSize->700]];
