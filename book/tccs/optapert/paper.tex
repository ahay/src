...
\inputdir{theo}
\plot{theo_model}{width=0.8\columnwidth}{Theoretical model with two plane reflectors and one diffractor.}
...
\inputdir{depthMig}
\plot{dm_zo}{width=0.8\columnwidth}{Zero-offset section corresponding to the Marmousi-velocity model.}
