function lowf3d(data,tf1,tf2,tf3,tf4,tf5,tf6)
...
for i=1:nx
	...
	d1=[d1,sum(abs(dtf(1:20,:)))'];	% 1Hz -> 20 Hz
	d2=[d2,sum(abs(dtf(21:40,:)))'];	% 21Hz -> 40 Hz
	d3=[d3,sum(abs(dtf(41:60,:)))'];
	d4=[d4,sum(abs(dtf(61:80,:)))'];
	d5=[d5,sum(abs(dtf(81:100,:)))'];
	d6=[d6,sum(abs(dtf(101:120,:)))'];
