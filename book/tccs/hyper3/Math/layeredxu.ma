...
(*A4avL2 =-2(  (η2L2)c^2-  (η3L2)c^2 s^2 +  (η1L2 )s^2)/(t0^2 /A2L2^2)/.t0->2 (depth2/Sqrt[5.9375]);
A4avL3 =-2(  (η2L3)c^2-  (η3L3)c^2 s^2 +  (η1L3 )s^2)/(t0^2 /A2L3^2)/.t0->2 (depth3/Sqrt[5.9375]);*)
