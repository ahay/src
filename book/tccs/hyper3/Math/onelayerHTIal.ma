...
Q4 =  (-2η2) (1/(c33(1+2δ2)))^2c^4/t0^2;
vhor = (1/2)((c11+c55)c^2+(c33+c55)s^2)+(1/2)Sqrt[((c11-c55)c^2-(c33-c55)s^2)^2+4(c13+c55)^2c^2s^2];(*phase velocity suggested by the authors*) 
Q=Q4/(1/vhor - Q2);
al = t0^2 + Q2 rortho^2 + Q4 rortho^4/(1+Q rortho^2)/.t0->2 depth/Sqrt[c33]/.{c11->5.05958,c33->7.08624,c13->1.03293,c23->3.08624,c44->2,c55->2.25};
alrms[radius_,angle_]:= 100Abs[Sqrt[al]/exacttime-1]/.{theta->angle}/.{p1->maxr Cos[angle],p2->maxr Sin[angle],R->radius};

onelayerHTInmo = Rasterize[ParametricPlot3D[{xoffset,yoffset,100Abs[Sqrt[al]/exacttime-1]}/.{p1->maxr Cos[theta],p2->maxr Sin[theta]},{R,0,1},{theta,0,2Pi},PlotRange->{All,All,All},Boxed->False,BoxRatios->{1,1,0.3},Axes->{True,True,False},AxesLabel->{"x/H","y/H"},Ticks->{{-4,-3,-2,-1,0,1,2,3,4},{-4,-3,-2,-1,0,1,2,3,4}},ColorFunctionScaling->False,ColorFunction->ColorData[{"DarkRainbow",{0,0.75}}],Lighting->{{"Ambient",White,{0,0,5}}},ViewPoint->{0,0,Infinity},LabelStyle->{Black,FontSize->22,FontFamily->"Times",FontWeight->"Bold"},TicksStyle->Directive[Thick,20],Mesh->19,ImageSize->500,PlotLegends->BarLegend[Automatic,LegendLabel->Placed["Error %",Above],LabelStyle->Directive[FontSize->22,FontFamily->"Times",Black,Bold]]]]
(*Export["~/Desktop/onelayerHTIal.eps",%]*)

Export["junk_ma.eps",onelayerHTInmo,"EPS"]
