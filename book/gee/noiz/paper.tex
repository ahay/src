...
\activeplot{cauchy}{width=6in,height=3.2in}{CR}{
        The coordinate is $m$.
...
\moddex{irls}{weighting functions for iterative reweighting}
% end Sergey's insertion
%\end{notforlecture}
...
\activeplot{burst90}{width=6.0in,height=2.25in}{ER}{
...
\activeplot{medbin90}{width=6in,height=3.8in}{ER}{
...
\activeplot{duelin90}{width=6in,height=3.0in}{ER}{
...
\activeplot{dueleither90}{width=6in,height=3.0in}{ER}{
...
\activeplot{duelversus90}{width=6in,height=3.0in}{ER}{
...
Figure~\ref{fig:synsat90} shows an interesting topography
...
\activeplot{synsat90}{width=6in,height=1.8in}{ER}{
...
\par
Although the geometry of Figure~\ref{fig:synsat90} is somewhat unusual,
...
The result is shown on the right in Figure~\ref{fig:seasat90}.
...
\activeplot{seasat90}{width=6in,height=1.8in}{ER}{
...
Figure~\ref{fig:seasat90} uses two different values of $\bold A_h$,
