...
\sideplot{puckin}{width=3in}{
	Input synthetic seismic data includes a low level of noise.\viewit{puckin}}  

\sideplot{residual}{width=3in}{
...
\sideplot{TwoD}{width=3in}{
	A seismic line before and after flattening.\viewit{TwoD}}  
%
...
\moddex{cgstep}{one step of CD}{51}{85}{api/c}
\par
...
\moddex{tinysolver}{tiny solver}{23}{57}{api/c}
...
negative vector divergence. Here it is: \opdex{igrad2}{igrad} 
...
\plot{veshigh90}{width=6in,height=3in}{
        Estimated altitude.
        \viewit{veshigh90}}
