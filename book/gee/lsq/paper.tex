...
\moddex{cgstep}{one step of CD}{38}{96}{filt/lib}
\par
...
\moddex{tinysolver}{tiny solver}{23}{53}{user/gee}
...
which is just like
\texttt{cgmeth} \vpageref{lst:cgmeth} except that the matrix-multiplication operator
...
like the modules \texttt{cgmeth()} \vpageref{lst:cgmeth} and 
