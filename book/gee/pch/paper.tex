...
\opdex{patch}{extract patches}{41}{66}{user/gee}
...
\moddex{patching}{generic patching}{27}{84}{user/gee}
...
\moddex{lopef}{local PEF}{61}{84}{user/gee}
...
\activeplot{dune3D}{height=4in,width=6in}{ER}{
...
\opdex{signoi}{signal and noise separation}
...
\activeplot{signoi}{width=6in,height=2.0in}{ER}{
...
\activeplot{signeps}{width=6in,height=2.0in}{ER}{
...
\activeplot{sneps+2}{width=6.5in,height=8.0in}{ER}{
        Stack of Shearer's IDA data (left).
...
is introduced in module
	...
	\moddex{nhelix}{non-stationary convolution}
...
Nonstationary helixes are created with
	...
	\moddex{createnhelixmod}{create non-stationary helix}
...
\opdex{nhconest}{non-stationary convolution}
...
%\begin{notforlecture}
\opdex{npolydiv}{non-stationary polynomial division}
...
\moddex{npef}{non-stationary PEF}
Near the end
...
\activeplot{tvdecon}{width=6.0in,height=3in}{ER}{
