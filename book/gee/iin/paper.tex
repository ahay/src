...
\par
\opdex{laplac2}{Laplacian in 2-D}{34}{78}{user/fomels} 
...
\moddex{lapfill}{Find 2-D missing data}{63}{76}{user/fomels}
...
\moddex{grad2fill}{low cut missing data}{52}{60}{user/fomels}
...
\inputdir{invint}
In Chapter \ref{ajt/paper:ajt} we defined \bx{linear interpolation}
\sx{interpolation}
