...
%\plot{marm}{width=5.5in}{Finite-difference wavefronts in the isotropic (top)
%  and anisotropic (bottom) Marmousi models. A significant shift in the
%  wavefront position suggest possible positioning error when seismic imaging
%  does not take anisotropy into account.}

%\plot{marmmod}{width=5.5in}{Alkhalifah's anisotropic Marmousi model. Top:
%  vertical velocity. Bottom: anelliptic $\eta$ parameter. The vertical
%  velocity is taken equal to the NMO velocity $V_n$.}
