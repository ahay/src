...
angle = 20. Pi/180;
dd = 2.0;
Do[xss = 0.5*{VnmTTI[N[1*i*Pi/180], .2, 0.2, 2.0, vs, -angle, .2, 0.2,
        2.0, vs, .0, .2, 0.2, 2.0, vs, 0.0, dd, 0.0, 0.0][[1]] - 
     VnmTTI[-N[1*i*Pi/180], .2, 0.2, 2.0, vs, -angle, .2, 0.2, 2.0, 
    ...
    VnmTTI[N[1*i*Pi/180], .2, 0.2, 2.0, vs, -angle, .2, 0.2, 2.0, 
     ...
     VnmTTI[-N[1*i*Pi/180], .2, 0.2, 2.0, vs, -angle, .2, 0.2, 2.0, 
       vs, .0, .2, 0.2, 2.0, vs, 0.0, dd, 0.0, 0.0][[2]]};
 dt = xss[[2]] - 
   Vnmapt[xss[[1]], .2, 0.2, 2.0, vs, .2, 0.2, 2.0, vs, .2, 0.2, 2.0, 
     vs, 1., 0.5, 0.5][[1]];
 ...
 dt = xss[[2]] - 
   Vnmapt[xss[[1]], .2, 0.2, 2.0, vs, .2, 0.2, 2.0, vs, .2, 0.2, 2.0, 
     vs, 1., 0.5, 0.5][[3]];
 fxst3 = Append[fxst3, {xss[[1]]/2, 100. dt/xss[[2]]}];
 dt = xss[[2]] - 
   0.5*LinVeikdsEll[xss[[1]], .2, 0.2, 2, angle, 2][[2]] - 
   0.5*LinVeikdsEll[-xss[[1]], .2, 0.2, 2, angle, 2][[2]];
 fxst4 = Append[fxst4, {xss[[1]]/2, 100. dt/xss[[2]]}];
 dt = xss[[2]] - 
   0.5*LinVeikdsTTI[xss[[1]], .2, 0.2, 2, angle, 2][[7]] - 
   0.5*LinVeikdsTTI[-xss[[1]], .2, 0.2, 2, angle, 2][[7]];
 fxst5 = Append[fxst5, {xss[[1]]/2, 100. dt/xss[[2]]}];
 dt = xss[[2]] - LinVeikdsEll[xss[[1]], .2, 0.2, 2, angle, 2][[8]];
 fxst6 = Append[fxst6, {xss[[1]]/2, 100. dt/xss[[2]]}];
 dt = xss[[2]] - LinVeikdsEll[xss[[1]], .2, 0.2, 2, angle, 2][[7]];
 fxst7 = Append[fxst7, {xss[[1]]/2, 100. dt/xss[[2]]}], {i, 0, 60}];
bb1 = ListPlot[fxst6, Joined -> True, 
...
ll = Show[bb1, bb3, bb2, Frame -> True, GridLines -> Automatic, 
