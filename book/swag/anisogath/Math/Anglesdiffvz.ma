...
d = ShowLegend[
  ContourPlot[
   angleValue[2, 1.8, 0.3, phx, pmx, 60][[2]] - 
    angleValue[2, 1.2, 0.3, phx, pmx, 60][[2]], {phx, -35, 
...
RowBox[{\"-\", \"1\"}]]\)"],}}, 
   ...
   PlotRange -> {{-35, 35}, {-35, 35}, {-0.4, 0.4}}], {ColorData[
      "Rainbow"][1 - #1] &, 13, "0.4", "-0.4", 
   LegendPosition -> {0.9, -0.7}, LegendSize -> 1.3, 
   LegendLabel -> 
    Style["\!\(\*SuperscriptBox[\"\[CapitalDelta]\[Theta]\", \
\"o\"]\)", 14]}];
dd = ShowLegend[
  ContourPlot[
   angleValue[2, 1.8, 0.0, phx, pmx, 60][[2]] - 
    angleValue[2, 1.2, 0.0, phx, pmx, 60][[2]], {phx, -35, 
    35}, {pmx, -35, 35}, Contours -> 20, 
   FrameLabel -> {{Subscript[k, mx]["\!\(\*SuperscriptBox[\"km\", 
RowBox[{\"-\", \"1\"}]]\)"],}, {Subscript[k, hx][
       "\!\(\*SuperscriptBox[\"km\", 
RowBox[{\"-\", \"1\"}]]\)"],}}, 
   ...
   LegendLabel -> 
    Style["\!\(\*SuperscriptBox[\"\[CapitalDelta]\[Theta]\", \
\"o\"]\)", 14]}];
mm = GraphicsRow[{dd, d}, ImageSize -> {600, 320}, AspectRatio -> 1, 
  Spacings -> 0];
Display["junk_ma.eps", mm, "EPS"];
