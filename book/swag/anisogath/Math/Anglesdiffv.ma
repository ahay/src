...
e = ShowLegend[
  ContourPlot[
   angleValue[2, 1.8, 0.3, phx, pmx, 60][[2]] - 
    angleValue[1.4, 1.8, 0.3, phx, pmx, 60][[2]], {phx, -35, 
...
f =
 ShowLegend[
  ContourPlot[
   angleValue[2, 2, 0.0, phx, pmx, 60][[2]] - 
    angleValue[1.4, 2, 0.0, phx, pmx, 60][[2]], {phx, -35, 
    35}, {pmx, -35, 35}, Contours -> 20, 
   FrameLabel -> {{Subscript[k, mx]["\!\(\*SuperscriptBox[\"km\", 
RowBox[{\"-\", \"1\"}]]\)"],}, {Subscript[k, hx][
       "\!\(\*SuperscriptBox[\"km\", 
RowBox[{\"-\", \"1\"}]]\)"],}}, 
   ...
   LegendLabel -> 
    Style["\!\(\*SuperscriptBox[\"\[CapitalDelta]\[Theta]\", \
\"o\"]\)", 14]}];
mm = GraphicsRow[{f, e}, ImageSize -> {600, 320}, AspectRatio -> 1, 
  Spacings -> 0];
