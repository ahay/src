...
\inputdir{.}
	...
	{\small \shortcite{claerbout-brown}}, which presented a texture synthesis technique utilizing
...
\section{ Applications}
	...
	Claerbout {\small \shortcite{gee}} preconditions with the inverse of the convolutional 
...
\section{ Discussion}
	...
	{\small \shortcite{claerbout-brown}} have recently been incorporated into Jon Claerbout's 
	textbook, {\em Geophysical Estimation by Example} {\small \shortcite{gee}}.  
