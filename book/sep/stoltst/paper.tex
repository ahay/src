...
\longcite{GEO52-05-06180643}, the cascaded $f$-$k$ migration
...
The $W$ factor is defined by \longcite{GEO43.01.00230048} as an
...
heuristic guess.  That is why \longcite{levin35} jokingly called the
$W$ parameter ``infamous'', and \longcite{GEO52-05-06180643} called it
``esoteric.''
...
\longcite{muir} propose a new interpolation scheme for improving the
practical accuracy of the method. \longcite{sava} uses a variation of
...
\longcite{GEO43.01.00230048} suggested the following change of the
...
curve.  \longcite{Levin.sep.42.373} applied the stationary
...
Following the study by \longcite{GEO54.06.07010717}, we selected a
...
\plot{data-ststr-pshift-casc}{width=6in,totalheight=9in}{(a) Section
  ...
  Stolt-stretch approach (6 velocities).}
...
\longcite{GEO53.07.08810893}. The theory of cascaded migration proves
...
+ v_2^2 + v_3^2$. (c) Decomposition in a cascade of 6 models,
such as $v^2 = v_1^2 + v_2^2 + v_3^2 + v_4^2 +
v_5^2 + v_6^2$}
\par
...
\longcite{GEO54.06.07010717} have shown that four-stage cascaded {\it
...
Stolt-stretch, with 3 and 6 velocities, respectively.}

\plot{dip-zoom}{width=6in}{Zoom in the salt body area where steep dips
are located. (a) Migration with the Stolt-stretch method. (b)
Migration with the phase-shift method. (c) and (d) Migrations with the
cascaded Stolt-stretch approach, using, respectively, 3 and 6 velocities.}
