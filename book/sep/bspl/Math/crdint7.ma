...
z2[x_]:=(2472 - 392 x - 504 x^2 - 1960 x^3 + 2520 x^4 - 1176 x^5 + 
	252 x^6 - 21 x^7)/5040;
...
spl[x_ /; Abs[x] > 4] := 0;
f[n_]:=Sum[(-1)^k (a z)^k,{k,0,n}] Sum[(-1)^k (a /z)^k,{k,0,n}] 
    Sum[(-1)^k (b z)^k,{k,0,n}] 
    Sum[(-1)^k (b /z)^k,{k,0,n}]Sum[(-1)^k (c z)^k,{k,0,n}] 
    Sum[(-1)^k (c /z)^k,{k,0,n}]/d
f[100]/.{a->0.535281,b->0.122555,c->0.00914759,d->0.330597}
Series[Expand[%],{z,0,15}]
Simplify[2(Integrate[Cos[w x] z1[x],{x,0,1}]+
	   ...
	   (z1[0] + 2 z2[1] Cos[w] + 2 z3[2] Cos[2 w] + 2 z4[3] Cos[3 w])];
Plot[Sum[SeriesCoefficient[%%,k] spl[x-k], {k,-15,15}],{x,-6,6},
	PlotStyle->{Thickness[0.01]},
	Frame->True,PlotRange->All,
  	FrameLabel->{None,None,"B-spline interpolator: B-7",None}];
