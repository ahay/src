...
shown by \longcite{Prucha.sep.100.marie1}, the ray 
...
\cite{Fomel.sep.84.179,Fomel.sep.92.159,Fomel.segab.97}. 
\par
...
\longcite{fowler}, this condition is sufficient for proving the
...
\cite{tam,vor,tygel}. The true-amplitude weighting provides an
...
As pointed out by \longcite{Prucha.sep.100.marie1}, the angle gathers
...
\bibliography{SEP,MISC,GEOTLE,angle,angle2}
