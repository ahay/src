...
Nichols\shortcite{Claerbout.sep.82.183}
...
Claerbout \shortcite{Claerbout.sep.95.jon1}
proposed
...
\activeplot{qdome-reflectors}{width=5in,height=3.6in}{}{Left, a synthetic seismic section with 
...
\activeplot{qdome-combo1}{height=3.4in,width=6.0in}{}{Left, correct velocity field; middle, well subset selected as input;
...
\activeplot{qdome-combo4}{height=3.4in,width=6.0in}{}{Left model (our goal), middle well logs, and right estimated model
after 12 iterations.}
...
\activeplot{shot-s-combo}{width=6in,height=3.8in}{}{Left, synthetic shot gather; center,
...
\activeplot{wz-25-combo}{width=6in,height=7in}{}{Top left, original shot
...
Generally, Toldi\shortcite{Toldi.sep.43} related perturbations in 
interval slowness
...
\FIG{toldi-steer},  left panel) where the perturbations from zero follow a 
sinusoidal path, and the anomalies go from positive to negative as you go
from left to right.  
We  used Toldi's forward operator to compute
stacking velocities at various depth levels (Figure \FIG{toldi-stack}, 
...
\par
The center panel of Figure \FIG{toldi-steer} shows the inversion result.  
...
Figure \FIG{toldi-steer} shows we did a substantially better job 
...
slope-estimation method of \longcite{Claerbout.blackwell.92}, used by
\longcite{Bednar.sep.95.bednarb} for calculating coherency attributes.
