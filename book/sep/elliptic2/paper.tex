...
\plot{verthoriz}{width=5.9in}{verthoriz}
{
...
\plot{verthoriz2}{width=5.9in}{verthoriz2}
{
Three different approximations (dashed curves) to the
...
\plot{Compare}{width=5.6in}{Compare}
{
...
\plot{Compare2}{width=5.6in}{Compare2}
{
...
\section{References}
\reference{Karrenbach, M., 1991, Anisotropic scalar imaging using the double
elliptic approximation: SEP--{\bf 70}.}
\reference{Muir, F., 1990, A modified anisotropic system:
SEP--{\bf 67}, 41--42.}
\reference{Muir, F., 1991, Various equations for TI media: SEP--{\bf 70}.}
