...
by \longcite{Claerbout.sep.77.19,Claerbout.gem.97}. Predicting a
...
\longcite{Schwab.sepphd.99} discusses this approach in more detail.
\par
...
technique of \longcite{Fomel.sep.95.sergey1}, based on recursive
