...
\activeplot{Gulfaa}{height=7in}{.}{(a) Near-offset section from the Gulf of
...
\activeplot{Gulfaper}{height=7in}{.}{(a) Kirchhoff migration
...
\activeplot{Zoom2}{height=7.5in,width=6.0in}{.}{ Close up of (a) the
...
will occur when the criteria of equation~\EQN{crit} are met.
...
\activeplot{Miglow}{height=7in}{.}{Kirchhoff migration of Gulf of Mexico data
