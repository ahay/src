...
\ABS{For every two-dimensional system with helical boundary
...
Previous authors, for example \longcite{gee}, take advantage of
...
In a laterally homogeneous earth, \longcite{kelamis:00} show that 
...
\bibliography{tvdecon,SEP,GEOPHYSICS,ref}
