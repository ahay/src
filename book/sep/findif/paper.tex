...
\ABS{ Implicit extrapolation is an efficient and unconditionally
...
\longcite{Nichols.sep.70.31}.  In this paper, we demonstrate the
...
understood through an example. Following \longcite{Claerbout.blackwell.85},
...
case, the matrix $\bold{A}_2$ represents a convolution with a
...
in detail by \longcite{Claerbout.sep.95.jon1}. According to this
...
\longcite{Li.sep.48.85} and \cite{Fomel.sep.92.159}. 
...
extrapolators, popularized by \longcite{GPR36.02.00990114} and
\longcite{GEO56.11.17701777}. However, it hides the danger of losing
the property of unconditional stability, which is obviously the major
asset of implicit extrapolators.
\par
Another route, partially explored by \longcite{Nichols.sep.70.31}, is
...
\bibliography{SEP,MISC,EAEG,GEOTLE,paper}
...
\activesideplot{sixth}{width=2.5in}{CR}{The second-derivative operator
