...
al. \shortcite{gill} and its bibliography. The famous
conjugate-gradient solver possesses specific properties, well-known
from the original works of Hestenes and Stiefel \shortcite{hestenes}
and Fletcher and Reeves \shortcite{fletcher}. For linear operators and
...
\shortcite{Claerbout.blackwell.85,Claerbout.tdf.82} shows dozens of
...
David Lumley \shortcite{Lumley.sep.82.63} and Dave Nichols
\shortcite{Nichols.sep.82.1}.
...
\bibliographystyle{sep}\bibliography{paper,MISC,SEP}
