...
\activeplot{galpat}{width=6.0in,height=2.in}{figdir}{Simple binning of a patch.
...
$  .
\end{center}
\activeplot{gallap}{width=6.0in,height=2.in}{figdir}{Interpolation on the dense
...
%\pagebreak
\activeplot{galsen}{width=5.0in,height=3.in}{figdir}{Sea of Galilee
data after LS 
...
\bibliographystyle{sep}\bibliography{MISC,SEP,SEGCON,GEOPHYSICS,paper}
