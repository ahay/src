...
\shortcite{Biondi.sep.80.125}.  According to this approach, an AMO
...
\shortcite{GPR29.03.03740406}. As with the DMO case, the
...
same purpose by Biondi and Chemingui \shortcite{Biondi.sep.80.125}.
\par
...
\shortcite{Biondi.sep.80.125}, where it was  
...
the wave field. As shown by Stovas and Fomel \shortcite{myDMO}, 
...
correspond to Hale's \shortcite{Hale} and Zhang's
\shortcite{Zhang.sep.59.201} DMO operators.
\par
...
Deregowski and Rocca \shortcite{GPR29.03.03740406} applied
...
by Deregowski and Rocca \shortcite{GPR29.03.03740406}.      
\par
...
Rocca \shortcite{GPR29.03.03740406} derived the following connections
...
\activesideplot{amocom}{width=3.5in}{figdir}{Traveltime curves
...
\activeplot{amoavs}{width=5.in,height=3.5in}{figdir}{AMO impulse
...
operator (\ref{eqn:AMO}). Biondi and Chemingui \shortcite{Biondi.sep.80.125}
...
%\nopagebreak
\bibliographystyle{sep}\bibliography{SEP,EAEG,../sergey4/paper,GEOTLE}

%\pagebreak
\appendname{A}\appendix\sephead{APPENDIX A}
\section{AMO AMPLITUDE}
...
%}
%\pagebreak
\appendname{B}\appendix\sephead{APPENDIX B}
\section{DERIVING THE AMO APERTURE}
\activesideplot{amosym}{width=3.5in}{figdir}{Reflection from the
...
\shortcite{GPR29.03.03740406}. The equality in (\ref{eqn:x0leq}) is achieved 
