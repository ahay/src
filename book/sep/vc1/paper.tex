...
publications} \cite[]{me,Fomel.segab.97}.  \cite{hubral} and
...
%geometric meaning illustrated in Figure \FIG{vlczor}. 
The
...
\sideplot{vlczor}{width=4in}{Zero-offset reflection in a constant
...
\sideplot{vlcve1}{width=6in}{Summation paths of the
simplified prestack residual migration for a series of depth
diffractors. Residual slowness $v/v_d$ is 1.2; half-offset $h$ is 1
km. This figure is to be compared with Etgen's Figure 2.4, reproduced in Figure~\ref{fig:vlcve3}.}

\sideplot{vlcve2}{width=6in}{Summation paths of the simplified
...
compared with Etgen's Figure 2.5, reproduced in Figure~\ref{fig:vlcve4}.}
...
\new{The derivation of the residual DMO+NMO kinematics is detailed in Appendix B.}
Figure \FIG{vlcvcp} illustrates it with the theoretical impulse response
curves. Figure \FIG{vlccps} compares the theoretical curves with the result of
...
\sideplot{vlcve3}{width=6in}{Summation paths of prestack
residual migration for a series of depth diffractors. Residual
slowness $v/v_d$ is 1.2; half-offset $h$ is 1 km. This figure reproduces
Etgen's Figure 2.4.}

\sideplot{vlcve4}{width=6in}{Summation paths of prestack
residual migration for a series of depth diffractors. Residual
slowness $v/v_d$ is 0.8; half-offset $h$ is 1 km. This figure reproduces
Etgen's Figure 2.5.}
...
\putbib[SEP,MISC,GEOTLE,EAEG,paper,spec,velcon,SEG]
...
\sideplot{vlcray}{width=6in}{Reflection rays in a constant
velocity medium (a scheme).}
...
\FIG{vlcray} \cite[]{ofcon}. For example, equation (\ref{eq:dzdv}) can
...
\APPENDIX{B}
\section{Derivation of the residual DMO kinematics}
...
illustrated in Figure \FIG{vlcvoc}. The three plots in the figure show
...
\sideplot{vlcvoc}{width=5in}{Kinematic residual NMO+DMO
...
NMO procedure. Offset continuation back to zero offset forms the
