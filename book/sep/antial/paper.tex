...
\longcite{gray} and \longcite{SEG-1994-1282}, and Hale's spatial
...
\shortcite{GEO56.06.07950805} points out that the steep parts of the
...
Figure \ref{fig:amotra}, borrowed from \longcite{Claerbout.bei.95},
...
\plot{amotra}{height=2in}{Figure borrowed from
  \longcite{Claerbout.bei.95} to illustrate the reciprocity
...
\plot{amospe}{height=2.5 in}{Top is the spectrum of the
...
Following \longcite{Biondi.geo.alias.98}, I illustrate 3-D
