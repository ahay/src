...
pccin=plot(ccin,(x,-2,2),thickness=3,aspect_ratio=12/golden_ratio)
wccin=plot(ccinf(w),(w,-2*pi,2*pi),ymin=-0.2,thickness=3,color='red',aspect_ratio=4*pi/golden_ratio,ticks=[[-pi,pi],None])
