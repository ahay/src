...
Azimuth moveout (AMO), introduced by \longcite{firstamo}, is used as
part of the styling goal (in conjunction with a derivative as a
roughener) in \longcite{Biondi.sep.110.biondo1}. This paper describes the
...
introduced by \longcite{bolondi} increases the computational
...
Discrete Fourier Transforms. \longcite{gardner}, \longcite{black} and
\longcite{zhou} derived equivalent and accurate log-stretch,
...
Starting from the parametric DMO relations of \longcite{black},
\longcite{zhou} derives an expression for a DMO applicable on 2D NMO-ed
