...
# ------------------------------------------------------------
def fdx(par):
    return ''.join(list(filter('%s' %('0,'+s_coefm+','  +s_coefp     ),par))) + '| transp'
def cdx(par):
    return ''.join(list(filter('%s' %(     c_coefm+',0,'+c_coefp     ),par))) + '| transp'
def bdx(par):
    return ''.join(list(filter('%s' %(     s_coefm+','  +s_coefp+',0'),par))) + '| transp'
# ------------------------------------------------------------
def fdz(par):
    return ''.join(list(filter('%s' %('0,'+s_coefm+','  +s_coefp     ),par)))
def cdz(par):
    return ''.join(list(filter('%s' %(     c_coefm+',0,'+c_coefp     ),par)))
def bdz(par):
    return ''.join(list(filter('%s' %(     s_coefm+','  +s_coefp+',0'),par)))
# ------------------------------------------------------------
