...
$key = q/fig:brutestack141/;
$external_labels{$key} = "$URL/" . q|node4.html|; 
$noresave{$key} = "$nosave";

$key = q/fig:vtxystack141/;
...
$key = q/fig:shots-receivers/;
$external_labels{$key} = "$URL/" . q|node3.html|; 
$noresave{$key} = "$nosave";

$key = q/fig:scdeconcdps/;
$external_labels{$key} = "$URL/" . q|node5.html|; 
$noresave{$key} = "$nosave";
...
$key = q/fig:firstlook-shots/;
$external_latex_labels{$key} = q|8|; 
$noresave{$key} = "$nosave";

$key = q/fig:firstlook-nmomutecheck/;
$external_latex_labels{$key} = q|9|; 
$noresave{$key} = "$nosave";

$key = q/fig:firstlook-brutestack141/;
$external_latex_labels{$key} = q|10|; 
$noresave{$key} = "$nosave";
