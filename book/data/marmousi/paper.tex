...
\inputdir{fdmod}
\plot{vel}{width=\textwidth}{FD model geometry as performed on the Marmousi velocity model.  The \emph{X} represents the shot while the smaller
\emph{*} symbols represent receivers.}
...
\inputdir{fdmod}
\multiplot{4}{time5,time10,time15,time20}{width=.45\textwidth}{Images of the propagating wavefield in the Marmousi model generated by a finite
difference model.}
