...
nt=`   < $indata suwind count=1 | sugethw ns    | sed 1q | sed 's/.*ns=//'`
dt=`   < $indata suwind count=1 | sugethw dt    | sed 1q | sed 's/.*dt=//'`
delrt=`< $indata suwind count=1 | sugethw delrt | sed 1q | sed 's/.*delrt=//'`
