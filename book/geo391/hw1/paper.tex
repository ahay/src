...
\begin{abstract}
  ...
  \item Analyzing digital elevation data from the Mount St. Helens area. You will apply 
...
edit them in the file \texttt{hw1/paper.tex}. Please show all the
...
\sideplot{byte}{width=\textwidth}{Digital elevation map of Mount St. Helens area.}

Figure~\ref{fig:byte} shows a digital elevation map of the Mount St. Helens area in Washington. Start by reproducing this figure on your screen.
\begin{enumerate}
...
histogram for the elevation map values is shown in
Figure~\ref{fig:hist}. When different values in a histogram are not
uniformly distributed, the image can have a low contrast. One way of
improving the contrast is \emph{histogram equalization}.
