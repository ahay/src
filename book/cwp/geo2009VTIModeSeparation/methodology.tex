...
\rFg{Iso_polarvector} shows the polarization vectors of the P mode of
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\inputdir{Matlab}
\multiplot{2}{Iso_polarvector,Ani_polarvector}{width=.45\textwidth}
...
illustrated in \rfg{Ani_polarvector}, which shows the polarization
...
(\rFgs{oporder-mop8} and \subrfn{oporder-mop2}) for a VTI
...
$\epsilon$=0.25, $\delta$=-0.29 (\rFg{aniopsize-mop0-order8}) and a
VTI medium with anisotropy $\epsilon$=0.54, $\delta$=0
(\rfg{aniopsize-mop1-order8}).  }
