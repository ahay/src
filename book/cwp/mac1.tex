...
\def\rEq#1{Equation~\ref{#1}}
\def\req#1{equation~\ref{#1}}
\def\rEqs#1{Equations~\ref{#1}}
\def\reqs#1{equations~\ref{#1}}
\def\ren#1{\ref{#1}}
...
% ------------------------------------------------------------
% acknowledgment
\def\ackcwp{\cen{sponsors of the\\Center for Wave Phenomena\\at\\Colorado School of Mines}}
