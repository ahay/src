...
To setup the Madagascar environment in the JGB 3.216B computer lab, run the following command:
\begin{verbatim}
$ module load madagascar-devel
\end{verbatim}
You can put this command in your \verb+$HOME/.cshrc+ file to run them automatically at login time. \footnote{All commands above assume you are using the default \texttt{cshell} environment; certain modifications apply to different shell environments.} To setup the \LaTeX\ environment, run the following commands:
\begin{verbatim}
