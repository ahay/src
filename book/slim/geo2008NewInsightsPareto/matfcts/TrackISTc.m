function TrackISTc(Aname,x0name,xnname,rnname,lname,Iters,InnerIters)
% Author      : G. Hennenfent
...
[x, xnorms, rnorms, lambdas] = SolveISTc(A, y, Iters, InnerIters, [], 1);
...
% unload lambdas
rsf_create(lname,[length(lambdas);1]);
rsf_write(lambdas,lname);
