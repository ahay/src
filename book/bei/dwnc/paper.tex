...
filter such as subroutine \texttt{halfdifa()} \vpageref{lst:halfdifa}.
Here, however,
we will compare results of the unadorned subroutine \texttt{kirchfast()} \vpageref{lst:kirchfast}
with our new programs, \texttt{phasemig()} \vpageref{lst:phasemig} and \texttt{phasemod()} \vpageref{lst:phasemod}.
