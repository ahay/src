...
\sideplot{pgeometry}{width=4.0in}{
...
\activeplot{cheop}{height=3.4in}{NR}{
...
\activesideplot{ellipse1}{width=3.5in}{ER}{
...
Subroutine \texttt{flathyp()} \vpageref{/prog:flathyp} is easily prepared
from subroutine \texttt{kirchfast()} \vpageref{/prog:kirchfast} by
...
are found in Figures~\ref{fig:Cos.1} and \ref{fig:Cos.0}.
\activesideplot{Cos.1}{width=3.in,height=3.in}{ER}{
...
\newslide
\activesideplot{Cos.0}{width=3.in,height=3.in}{ER}{
	Forward modeling
...
\activeplot{simple}{height=2.5in}{NR}{
...
\activeplot{vertlay}{height=2.5in}{NR}{
...
\activeplot{twopoint}{height=2.4in}{NR}{
...
\activeplot{shell}{height=6.5in}{NR}{
...
\activesideplot{dipray}{width=3in}{NR}{
...
\activesideplot{lawcos}{width=3in}{NR}{
...
\activeplot{randip}{width=6in,height=3in}{.}{
...
\activeplot{shelikof}{height=3.3in}{.}{
...
\activeplot{cvstacks}{width=6.0in}{ER}{
...
made by subroutine~\texttt{velsimp()} \vpageref{/prog:velsimp}.
...
%
\activesideplot{velscan}{width=4.0in,height=3.3in}{ER}{
...
\activeplot{digicon}{height=3.8in}{NR}{
...
\activeplot{devlish}{height=3.8in}{NR}{
	{\em  Devilish} 
...
We did this with subroutine~\texttt{flathyp()} \vpageref{/prog:flathyp}
...
\activesideplot{frocca}{width=3in,height=2in}{ER}{
...
\activeplot{rocca2}{width=5in}{NR}{
	Rocca's smile. (Ronen)
	}
\newslide
...
Subroutine \texttt{flathyp()} \vpageref{/prog:flathyp} implements $\bold H$ and $\bold H'$.
...
\activesideplot{sergey}{width=3in,height=2in}{ER}{
...
\texttt{flathyp()} \vpageref{/prog:flathyp}.

\activeplot{yalei2}{width=6.in,height=1.5in}{ER}{ 
...
\activeplot{yalei1}{width=6.in,height=1.5in}{ER}{ 
...
\activeplot{ell}{width=4.in,height=3.in}{NR}{
...
Like subroutine~\texttt{flathyp()} \vpageref{/prog:flathyp},
our \bx{DMO} subroutine~\texttt{dmokirch()} \vpageref{/prog:dmokirch} is based on
subroutine~\texttt{kirchfast()} \vpageref{/prog:kirchfast}.
It is just the same,
...
were made with subroutine~\texttt{dmokirch()} \vpageref{/prog:dmokirch}. 
Notice the big noise reduction over Figure~\ref{fig:frocca}.
\activesideplot{dmatt}{width=3.in}{ER}{
	Impulse response of DMO and NMO
	}
\newslide
\activesideplot{coffs}{width=3.in}{ER}{
...
\activeplot{wgdmostk}{width=6.20in,height=7.8in}{ER}{
...
\activeplot{wgdmomig}{width=6.20in,height=7.8in}{ER}{
