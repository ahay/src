...
\sx{artifacts}
Reconstructing the earth model with the adjoint option in \texttt{kirchfast()} \vpageref{/prog:kirchfast}
...
an idea implemented in subroutine \texttt{halfdifa()} \vpageref{/prog:halfdifa}.
...
Subroutine \texttt{kirchfast()} \vpageref{/prog:kirchfast} does interpolation by moving values
...
\plot{wgkirch}{width=6.20in,height=8.5in}{
  Kirchhoff migration of Figure~\protect\ref{vela/fig:agcstack}.
