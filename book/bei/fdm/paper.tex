...
\moddex{Mheat}{heat-flow equation}{65}{72}{user/fomels}
\begin{verbatim}
alpha = 0.33
...
\end{verbatim}
\moddex{Mheat}{heat-flow equation}{51}{75}{user/fomels}
\begin{comment}
...
like subroutine~\texttt{rtris()} \vpageref{/prog:rtris}
...
subroutine \texttt{wavemovie()} \vpageref{/prog:wavemovie} yields wider angles.
...
in Tables \ref{fdm/paper:fdm}.4 and \ref{fdm/paper:fdm}.5 is arrived at by \bx{splitting}.
