...
\activeplot{cube}{width=6.00in,height=8.0in}{ER}{
...
\activesideplot{yc02}{height=4.0in,width=3.5in}{ER}{
...
\activesideplot{yc20}{height=4.0in,width=3.5in}{ER}{
...
$\Delta s = \Delta g/2$. %
\activesideplot{geqs}{width=2.5in}{ER}{
        $\Delta g = \Delta s$.
...
\activesideplot{geq2s}{width=2.5in}{ER}{
        $\Delta g = 2\Delta s$.
...
This is done in the first half of subroutine \texttt{synmarine()} \vpageref{/prog:synmarine}. %
\progdex{synmarine}{synthetic marine}
The second half of subroutine \texttt{synmarine()} \vpageref{/prog:synmarine}
...
\activesideplot{synmarine}{width=3in}{ER}{
...
\activesideplot{shotmovie}{width=3in}{ER}{
...
\activesideplot{wirecube}{height=1.0in}{NR}{
        }
