...
\activeplot{subsampvrsaa}{width=6.00in,height=2.25in}{ER}{
	500 channels (left),
...
\activeplot{migalias}{width=4.30in}{ER}{
...
\activesideplot{boxmo1}{width=3.00in,height=4in}{ER}{
...
A subroutine for causal summation is subroutine \texttt{causint()} \vpageref{/prog:causint}.
Recall that the
...
\activesideplot{boxmo0}{width=3.00in}{ER}{
...
as done in subroutine \texttt{doubint()} \vpageref{/prog:doubint}.
\progdex{doubint}{double integration} %
...
Subroutine \texttt{lint1()} \vpageref{/prog:lint1} does linear interpolation,
but here we need weighted results
as provided by \texttt{spotw()} \vpageref{/prog:spotw}.
...
\activesideplot{trimo0}{width=3.00in}{ER}{
	Triangle wavelets,
	accurately positioned,
	but aliased
	({\tt antialias=0.})
	}
\activesideplot{trimo1}{width=3.00in}{ER}{
...
\activesideplot{aamod}{width=3.00in}{ER}{
...
\activesideplot{aad0}{width=3.00in}{ER}{
...
\activesideplot{aad1}{width=3.00in}{ER}{
...
where subroutine \texttt{halfdifa()} \vpageref{/prog:halfdifa} was introduced
...
\activesideplot{aad1h}{width=3.00in}{ER}{
	Best synthetic data.
...
\activesideplot{aamig2}{width=3.00in}{ER}{
...
\activesideplot{aamig0}{width=3.00in}{ER}{
...
\activesideplot{croshyp}{width=2.5in}{ER}{
...
\activesideplot{aacdp}{width=3.00in}{ER}{
...
\item
	...
	linear interpolation in subroutine \texttt{trimo()} \vpageref{/prog:trimo}
