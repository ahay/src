...
\texttt{hw02/SConstruct} \\
\texttt{hw02/handout.tex} \\
\texttt{hw02/exercise/SConstruct} \\
\texttt{hw02/exercise/AFDM.c} \\
\texttt{hw02/bashrc}

\item
Copy the file \texttt{bashrc} to \texttt{$\sim$/.bashrc}, or if
\texttt{$\sim$/.bashrc} exists add the content of \texttt{bashrc} to your original
\texttt{$\sim$/.bashrc}.

\item 
\texttt{cd $\sim$/gpgn658/hw02} \par
...
\item 
\texttt{cd $\sim$/gpgn658/hw02/exercise} \par
...
\item 
\texttt{cd $\sim$/gpgn658/hw02} and run \texttt{scons read} to build and 
