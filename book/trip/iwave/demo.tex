...
\plot{fig1}{height=10cm,width=15cm}{Dome velocity model}
\plot{fig2}{height=10cm,width=15cm}{Dome density model}
\plot{fig3}{height=15cm,width=15cm}{2D shot record, 301 traces: shot x = 3300 m, shot z = 40 m, receiver x =
...
\plot{fig4}{height=15cm,width=15cm}{Trace 100 (receiver x = 2100 m) for $\Delta x = \Delta z = $
...
\plot{fig5}{height=15cm,width=15cm}{Trace 100 detail, 1.8-2.5 s, showing more clearly the
