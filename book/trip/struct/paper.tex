...
%\plot{line8-12km}{width=15cm}{Response of 12 seafloor pressure sensors at
 % 1.875 km depth, positioned 400 m apart starting at 8 km from left
%  edge of model, to 400 shots spaced 25 m apart at 6 m depth, source is isotropic point
 % derivative with peak frequency 5 Hz,}
%\plot{born8-12km}{width=15cm}{Linearized response (``Born modeling'') of seafloor pressure
%  sensors 400 shots, geometry as described in Figure
%  \ref{fig:line8-12km}, due to velocity-squared perturbation (Figure \ref{fig:dcsq_4layer}) about
%  smooth background (Figure \ref{fig:csq_4layersm}); other parameters
%  as in Figure \ref{fig:line8-12km}.}
%\plot{migr8-12km}{width=15cm}{Reverse-time migration of Born data
%  from Figure \ref{fig:born8-12km}.}
