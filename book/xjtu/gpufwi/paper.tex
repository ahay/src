...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{2D blocks in GPU memory. The marked window indicates that the shared memory in every block needs to be extended on each side with halo ghost points storing the grid value from other blocks.}\label{fig:blocks}
\end{figure}
