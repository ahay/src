...
\end{equation}
% A snapshot using the code provided in the appendix is shown in Figure~\ref{snapshot}, in which we use the sponge boundary condition.
% \begin{figure}
% \centering
...
\plot{snapshot}{width=0.8\textwidth}{A snapshot of 2-D acoustic propagation using PSM method}
