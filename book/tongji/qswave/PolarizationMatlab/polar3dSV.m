...
%bipolar3dtest(cc,threshold,'sv');
%print -depsc polar3dortSV.eps;

% VTI is a special case of ORT
% VTI model: Mesaverde shale (Thomsen, 1986)
%thoms = [3749,2621,0.225,0.078,0.10];
%cc = thoms2stiff_vti(thoms);
%bipolar3dtest(cc,threshold,'sv');
%print -depsc polar3dvtiSV.eps;
...
bipolar3dtest_hti(cc,threshold,'sv');
print -depsc polar3dhtiSV.eps;

% ISO model: 
%thoms = [4721,2890];
%cc = thoms2stiff_iso(thoms);
%bipolar3dtest(cc,threshold,'sv');
%print -depsc polar3disoSV.eps;
