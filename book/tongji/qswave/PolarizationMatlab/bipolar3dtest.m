function bipolar3dtest(cc,threshold,mode)
clf
...
if( mode=='sv' )
    h=quiver3(kx(1:jt:nt,1:jh:nh),ky(1:jt:nt,1:jh:nh),kz(1:jt:nt,1:jh:nh),...
           -ax(1:jt:nt,1:jh:nh).*az(1:jt:nt,1:jh:nh),-ay(1:jt:nt,1:jh:nh).*az(1:jt:nt,1:jh:nh),ax(1:jt:nt,1:jh:nh).*ax(1:jt:nt,1:jh:nh)+ay(1:jt:nt,1:jh:nh).*ay(1:jt:nt,1:jh:nh))
    set(h, 'Color', 'blue','LineWidth',1);
end

if( mode=='sh' )
    h=quiver3(kx(1:jt:nt,1:jh:nh),ky(1:jt:nt,1:jh:nh),kz(1:jt:nt,1:jh:nh),-ay(1:jt:nt,1:jh:nh),ax(1:jt:nt,1:jh:nh),zeros(nt/jt,nh/jh));
    set(h, 'Color', 'blue','LineWidth',1);
end
