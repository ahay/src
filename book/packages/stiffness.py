...
def vti2d(cc,vp,vs,ro,epsilon,delta,par):
    ...
    Flow(cc+'13',[cc+'33',cc+'55',delta],
         '''
         math output="sqrt(2*c33*(c33-c5)*delta+(c33-c55)*(c33-c55))-c55"
         c33=${SOURCES[0]}
         c55=${SOURCES[1]}
         delta=${SOURCES[2]}
         ''')
...
def tti2d(mm,vp,vs,ro,epsilon,delta,nu,par):
    ...
    Flow(mm+'11',[mm+'-cc11',mm+'-cc13',mm+'-cc33',mm+'-cc55',nu],
         '''
         ...
         nu=${SOURCES[4]}
         ''')
    Flow(mm+'13',[mm+'-cc11',mm+'-cc13',mm+'-cc33',mm+'-cc55',nu],
         '''
         ...
         nu=${SOURCES[4]}
         ''')
    Flow(mm+'15',[mm+'-cc11',mm+'-cc13',mm+'-cc33',mm+'-cc55',nu],
         '''
         ...
         nu=${SOURCES[4]}
         ''')
    Flow(mm+'33',[mm+'-cc11',mm+'-cc13',mm+'-cc33',mm+'-cc55',nu],
         '''
         ...
         nu=${SOURCES[4]}
         ''')
    Flow(mm+'35',[mm+'-cc11',mm+'-cc13',mm+'-cc33',mm+'-cc55',nu],
         '''
         math output="-(-c11+c33+(c11-2*c13+c33-4*c55)*cos(2*nu))*sin(2*nu)/4"
         c11=${SOURCES[0]}
         c13=${SOURCES[1]}
         ...
         nu=${SOURCES[4]}
         ''')
    Flow(mm+'55',[mm+'-cc11',mm+'-cc13',mm+'-cc33',mm+'-cc55',nu],
         '''
