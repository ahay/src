function [ D1 ] = fxymssa_win_auto2(D,flow,fhigh,dt,N,N2,verb,n1win,n2win,n3win,r1,r2,r3,mode)
%  FXYMSSA_WIN_auto2: local RR with automatically selected ranks
%  
%  IN   D:   	intput 3D data
...
D1=win3d(@localfxymssa_auto, param, D, n1win, n2win, n3win, r1, r2, r3);
