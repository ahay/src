function [ D1,H ] = fxymssa_auto(D,flow,fhigh,dt,Nmax,verb,mode,f,eps)
%  FXYMSSA: Rank reduction method with automatically selected ranks
...
function [dout,H]=P_R(din,Nmax,mode,eps)
