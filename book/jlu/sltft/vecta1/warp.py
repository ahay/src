...
def nwarp2(name,       # name prefix
    ...
    for i in range(iter):
        ...
        Flow(ppltft,pp,
             '''
             sltft eps=0.98 rect=%d verb=n | transp
             ''' % frect,split=[2,471,[0]],reduce="cat axis=3")
        ...
        sr = n('sr')
        pr = n('pr')
        Flow(pr,ppshape,'transp | sltft eps=0.98 inv=y verb=y')
        Flow(sr,pswshape,'transp | sltft eps=0.98 inv=y verb=y')
        ...
        if i == iter-1:
            ...
            Plot(in1,[pr+'in1',psw+'2in1'],giplot('SLTFT'))
...
def warp1(name,      # name prefix
    ...
    for i in range(iter):
        ...
        sltft = 'sltft eps=0.98 rect=%d | transp' % frect
        ...
        Flow(pr,ppft+'b','transp | sltft eps=0.98 inv=y')
        Flow(sr,psft+'b','transp | sltft eps=0.98 inv=y')
