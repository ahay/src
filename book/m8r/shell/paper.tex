\title{Guide to Madagascar programs}
\email{sergey.fomel@beg.utexas.edu}
\author{Sergey Fomel}
\lefthead{Fomel}
\righthead{Madagascar programs}
...
\subsubsection{Implementation: \href{http://sourceforge.net/p/rsf/code/HEAD/tree/trunk/system/main/add.c}{system/main/add.c}}

The first input file is either in the list or in the standard input.
\moddex{add}{add}{103}{111}{system/main}
...
\moddex{add}{add}{112}{118}{system/main}

A helper function \texttt{check\_compat} checks the compatibility of
input files.
\moddex{add}{add}{424}{467}{system/main}
...
data type.  
\moddex{add}{add}{183}{203}{system/main}

The data combination program for floating point numbers is
\texttt{add\_float}.  
\moddex{add}{add}{264}{305}{system/main}
...
\subsubsection{Implementation: \href{http://sourceforge.net/p/rsf/code/HEAD/tree/trunk/system/main/attr.c}{system/main/attr.c}}

Computations start by finding the input data (\texttt{in}) size
(\texttt{nsiz}) and dimensions (\texttt{dim}).
\moddex{attr}{attr}{81}{84}{system/main}

In the main loop, we read the input data buffer by buffer.
\moddex{attr}{attr}{100}{122}{system/main}

The data attributes are accumulated in corresponding double-precision
variables. 
\moddex{attr}{attr}{146}{147}{system/main}

Finally, the attributes are reduced and printed out.
\moddex{attr}{attr}{180}{187}{system/main}
\moddex{attr}{attr}{194}{203}{system/main}
...
\subsubsection{Implementation: \href{http://sourceforge.net/p/rsf/code/HEAD/tree/trunk/system/main/cat.c}{system/main/cat.c}}

The first input file is either in the list or in the standard input.
\moddex{cat}{cat}{64}{69}{system/main}
...
\moddex{cat}{cat}{71}{77}{system/main}
...
\moddex{cat}{cat}{99}{112}{system/main}
...
\moddex{cat}{cat}{132}{137}{system/main}

In the output, the selected axis will get extended.
\moddex{cat}{cat}{149}{163}{system/main}
...
\texttt{space=y}.
\moddex{cat}{cat}{184}{200}{system/main}
...
\subsubsection{Implementation: \href{http://sourceforge.net/p/rsf/code/HEAD/tree/trunk/system/main/cmplx.c}{system/main/cmplx.c}}

The program flow is simple. First, get the names of the input files.
\moddex{cmplx}{cmplx}{41}{57}{system/main}
...
\moddex{cmplx}{cmplx}{81}{91}{system/main}
...
\subsubsection{Implementation: \href{http://sourceforge.net/p/rsf/code/HEAD/tree/trunk/system/main/conjgrad.c}{system/main/conjgrad.c}}
...
\subsubsection{Implementation: \href{http://sourceforge.net/p/rsf/code/HEAD/tree/trunk/system/main/cp.c}{system/main/cp.c}}
...
\subsubsection{Implementation: \href{http://rsf.svn.sourceforge.net/viewvc/rsf/trunk/system/main/get.c?view=markup}{system/main/get.c}}

The implementation is trivial. Loop through all command-line parameters that contain 
the ``='' character.
\moddex{get}{get}{41}{43}{system/main}

Get the parameter value (as string) and output it as either
\texttt{key=value} or \texttt{value}, depending on the
\texttt{parform} parameter.  
\moddex{get}{get}{44}{50}{system/main}
