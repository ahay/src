...
def octave(context):
    ...
    if octave:
        ...
        if mkoctfile:
            ...
            need_pkg( context.env, 'mkoctfile')
    else: # octave not found
        context.Result(context_failure)
        stderr_write('Please install Octave.')
        need_pkg( context.env, 'octave')
