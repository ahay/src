...
<p>
<li>
Alternate methods for specifying computational grid and variable bulk 
...
<ul>
<li>bulkmod = [string], or kappa = [string]</li>
</ul>
</li>
<p>
...
<li>refkappa = [float] [default = 2250 MPa],</li>
<li>refbuoy  = [float] [default = 0.001 m^3/kg],</li>
<li>refvel   = [float] [default = 1.5 m/ms],</li>
<li>refden   = [float] [default = 1000 kg/m^3]</li>
</ul>
...
<p>
<li>Direct specification of buoyancy from RSF file, rather than density:
<ul>
<li>buoyancy = [string]</li>
</ul>
</li>
<p>
<li>Direct specification of buoyancy or density on shifted grids:
<ul>
  <li>buoyancy1 = [string] and</li>
  <li>buoyancy2 = [string] and</li>
  <li>buoyancy3 = [string], </li>
  </ul>
  or
  <ul>
...
<p>
<li>
Alternate methods for specifying time steps: see \ref asgnotes.
</li>
</ol>
*/
