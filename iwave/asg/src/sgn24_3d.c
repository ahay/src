...
Igor Terentyev.
********************************************************************************
Implementation of 2-4 scheme in 3D.
*/
/*============================================================================*/
...
int sgn_ts3d_24p012(RDOM *, void *);
int sgn_ts3d_24p0j(RDOM *, void *, int);
int sgn_ts3d_24p12(RDOM *, void *);
int sgn_ts3d_24p0(RDOM *, void *);
int sgn_ts3d_24p012(RDOM *, void *);
int sgn_ts3d_24pj(RDOM *, void *, int);
int sgn_ts3d_24p(RDOM *, void *);
int sgn_ts3d_24v0(RDOM *, void *);
int sgn_ts3d_24vj(RDOM *, void *, int);

int sgn_ts3d_24(RDOM *dom, int iarr, void *pars)
{
    ...
    {
      /*
        if ( ((SGN_TS_PARS*)pars)->psingle ) return sg_ts3d_24p(dom, &(((SGN_TS_PARS*)pars)->sgpars));
        else
      */
        {
            ...
            if ( e0 && e1 && e2 ) return sgn_ts3d_24p012(dom, pars);
            else if ( e0 && e1 )  return sgn_ts3d_24p0j(dom, pars, 1);
            else if ( e0 && e2 )  return sgn_ts3d_24p0j(dom, pars, 2);
            else if ( e1 && e2 )  return sgn_ts3d_24p12(dom, pars);
            else if ( e0 )        return sgn_ts3d_24p0(dom, pars);
            else if ( e1 )        return sgn_ts3d_24pj(dom, pars, 1);
            else if ( e2 )        return sgn_ts3d_24pj(dom, pars, 2);
            else                  return sgn_ts3d_24p(dom, pars);
        }
    }
    if ( iarr == D_V0 )
    {
      //if ( ((SGN_TS_PARS*)pars)->eflags[0] ) 
      return sgn_ts3d_24v0(dom, pars);
      //  else return sg_ts3d_24v0(dom, &(((SGN_TS_PARS*)pars)->sgpars));
    }
    if ( iarr == D_V1 )
    {
      //if ( ((SGN_TS_PARS*)pars)->eflags[1] )
      return sgn_ts3d_24vj(dom, pars, 1);
      //  else return sg_ts3d_24vj(dom, &(((SGN_TS_PARS*)pars)->sgpars), 1, D_P1);
    }
    if ( iarr == D_V2 )
    {
      //if ( ((SGN_TS_PARS*)pars)->eflags[2] ) 
      return sgn_ts3d_24vj(dom, pars, 2);
      //  else return sg_ts3d_24vj(dom, &(((SGN_TS_PARS*)pars)->sgpars), 2, D_P2);
    }
...
int sgn_ts3d_24p012(RDOM *dom, void *pars)
{
    ...
    register ireal * restrict _px, * restrict _py, * restrict _pz, * restrict _pxend,
                  * restrict _mpx, * restrict _epx, * restrict _vx3,
    ...
    register ireal lax, lay, laz, dt2, vx3, vx2, vx1, vx0, delta, etaxdt, etaydt, etazdt;
    RARR *s;
    INFODIM *dims;
    ...
    laz = ((SGN_TS_PARS*)pars)->lam[2] * C24;
    dt2 = ((SGN_TS_PARS*)pars)->dt / 2.0;
    
    #pragma omp parallel private(tsz,tid,iy,iz,_px,_py,_pz,_pxend,_mpx,_epx,_epy,_epz,_vx3,_vy3,_vy2,_vy1,_vy0,_vz3,_vz2,_vz1,_vz0,vx3,vx2,vx1,vx0,delta,etaxdt,etaydt,etazdt,dims)
    {
        #ifdef _OPENMP
        ...
        dims = s[D_V0 ]._dims;
        _vx3 = s[D_V0 ]._s + (gxs - dims[0].gs) + (gys - dims[1].gs + (tid - dims[2].gs) * dims[1].n0) * dims[0].n0 + 1;
        dims = s[D_V1 ]._dims;
        _vy2 = s[D_V1 ]._s + (gxs - dims[0].gs) + (gys - dims[1].gs + (tid - dims[2].gs) * dims[1].n0) * dims[0].n0;
        _vy3 = _vy2 + dims[0].n0;
        _vy1 = _vy2 - dims[0].n0;
        _vy0 = _vy1 - dims[0].n0;
        dims = s[D_V2]._dims;
        _vz2 = s[D_V2]._s + (gxs - dims[0].gs) + (gys - dims[1].gs + (tid - dims[2].gs) * dims[1].n0) * dims[0].n0;
            ...
            for ( iy = 0; iy < ny; ++iy )
            {
                ...
                for ( _pxend = _px + nx; _px < _pxend; )
                {
                    ...
                    delta = ((vx3 - vx0 + (vx1 - vx2) * 27.0) * lax + 
                             ((*_vy3++) - (*_vy0++) + ((*_vy1++) - (*_vy2++)) * 27.0) * lay +
                             ((*_vz3++) - (*_vz0++) + ((*_vz1++) - (*_vz2++)) * 27.0) * laz) * (*_mpx++);
                ...
                _px += px_a; _py += py_a; _pz += pz_a; _mpx += mpx_a; _vx3 += vx_a;
                _vy0 += vy_a; _vy1 += vy_a; _vy2 += vy_a; _vy3 += vy_a;
                _vz0 += vz_a; _vz1 += vz_a; _vz2 += vz_a; _vz3 += vz_a; _epx -= nx;
            }
            
            _px += px_aa; _py += py_aa; _pz += pz_aa; _mpx += mpx_aa; _vx3 += vx_aa;
            _vy0 += vy_aa; _vy1 += vy_aa; _vy2 += vy_aa; _vy3 += vy_aa;
            _vz0 += vz_aa; _vz1 += vz_aa; _vz2 += vz_aa; _vz3 += vz_aa; _epy -= ny; _epz += tsz;
        }
    } /* omp parallel */
...
int sgn_ts3d_24p(RDOM *dom, void *pars)
{
    ...
    register ireal * restrict _px, * restrict _py, * restrict _pz, * restrict _pxend,
                  ...
                  * restrict _vy3, * restrict _vy2, * restrict _vy1, * restrict _vy0,
                  * restrict _vz3, * restrict _vz2, * restrict _vz1, * restrict _vz0;
    register ireal lax, lay, laz, vx3, vx2, vx1, vx0, delta;
    RARR *s;
    INFODIM *dims;
    ...
    #pragma omp parallel private(tsz,tid,iy,iz,_px,_py,_pz,_pxend,_mpx,_vx3,_vy3,_vy2,_vy1,_vy0,_vz3,_vz2,_vz1,_vz0,vx3,vx2,vx1,vx0,delta,dims)
    {
        #ifdef _OPENMP
        tsz = omp_get_num_threads();
        tid = omp_get_thread_num();
...
int sgn_ts3d_24p0j(RDOM *dom, void *pars, int ind)
{
    ...
    register ireal * restrict _px, * restrict _py, * restrict _pz, * restrict _pxend,
                  ...
                  * restrict _vz3, * restrict _vz2, * restrict _vz1, * restrict _vz0;
    ireal * restrict _ep;
    register ireal lax, lay, laz, dt2, vx3, vx2, vx1, vx0, delta, etaxdt, etadt;
    RARR *s;
    INFODIM *dims;
    ...
    #pragma omp parallel private(tsz,tid,iy,iz,_px,_py,_pz,_pxend,_mpx,_epx,_ep,_vx3,_vy3,_vy2,_vy1,_vy0,_vz3,_vz2,_vz1,_vz0,vx3,vx2,vx1,vx0,delta,etaxdt,etadt,dims)
    {
        #ifdef _OPENMP
        tsz = omp_get_num_threads();
        tid = omp_get_thread_num();
        ...
        for ( iz = tid; iz < nz; iz += tsz )
        {
            for ( iy = 0; iy < ny; ++iy )
            {
                ...
                _px += px_a; _py += py_a; _pz += pz_a; _mpx += mpx_a; _vx3 += vx_a;
                _vy0 += vy_a; _vy1 += vy_a; _vy2 += vy_a; _vy3 += vy_a;
                _vz0 += vz_a; _vz1 += vz_a; _vz2 += vz_a; _vz3 += vz_a; _epx -= nx; _ep += ep_a;
            }
            
            _px += px_aa; _py += py_aa; _pz += pz_aa; _mpx += mpx_aa; _vx3 += vx_aa;
            _vy0 += vy_aa; _vy1 += vy_aa; _vy2 += vy_aa; _vy3 += vy_aa;
            _vz0 += vz_aa; _vz1 += vz_aa; _vz2 += vz_aa; _vz3 += vz_aa; _ep += ep_aa;
        }
    } /* omp parallel */
...
int sgn_ts3d_24p12(RDOM *dom, void *pars)
{
    ...
    register ireal * restrict _px, * restrict _py, * restrict _pz, * restrict _pxend,
                  ...
                  * restrict _vz3, * restrict _vz2, * restrict _vz1, * restrict _vz0;
    ireal * restrict _epy, * restrict _epz;
    register ireal lax, lay, laz, vx3, vx2, vx1, vx0, delta, etaydt, etazdt;
    ireal dt2;
    RARR *s;
    INFODIM *dims;
    ...
    #pragma omp parallel private(tsz,tid,iy,iz,_px,_py,_pz,_pxend,_mpx,_epy,_epz,_vx3,_vy3,_vy2,_vy1,_vy0,_vz3,_vz2,_vz1,_vz0,vx3,vx2,vx1,vx0,delta,etaydt,etazdt,dims)
    {
        #ifdef _OPENMP
        tsz = omp_get_num_threads();
        tid = omp_get_thread_num();
...
int sgn_ts3d_24pj(RDOM *dom, void *pars, int ind)
{
    ...
    register ireal * restrict _px, * restrict _py, * restrict _pz, * restrict _pxend,
                  ...
                  * restrict _vz3, * restrict _vz2, * restrict _vz1, * restrict _vz0;
    ireal * restrict _ep;
    register ireal lax, lay, laz, vx3, vx2, vx1, vx0, delta, etadt;
    ireal dt2;
    RARR *s;
    INFODIM *dims;
    ...
    #pragma omp parallel private(tsz,tid,iy,iz,_px,_py,_pz,_pxend,_mpx,_ep,_vx3,_vy3,_vy2,_vy1,_vy0,_vz3,_vz2,_vz1,_vz0,vx3,vx2,vx1,vx0,delta,etadt,dims)
    {
        #ifdef _OPENMP
        tsz = omp_get_num_threads();
        tid = omp_get_thread_num();
        ...
        for ( iz = tid; iz < nz; iz += tsz )
        {
            for ( iy = 0; iy < ny; ++iy )
            {
                ...
                _px += px_a; _py += py_a; _pz += pz_a; _mpx += mpx_a; _vx3 += vx_a;
                _vy0 += vy_a; _vy1 += vy_a; _vy2 += vy_a; _vy3 += vy_a;
                _vz0 += vz_a; _vz1 += vz_a; _vz2 += vz_a; _vz3 += vz_a; _ep += ep_a;
            }
...
int sgn_ts3d_24p0(RDOM *dom, void *pars)
{
    ...
    register ireal * restrict _px, * restrict _py, * restrict _pz, * restrict _pxend,
                  ...
                  * restrict _vy3, * restrict _vy2, * restrict _vy1, * restrict _vy0,
                  * restrict _vz3, * restrict _vz2, * restrict _vz1, * restrict _vz0;
    register ireal lax, lay, laz, dt2, vx3, vx2, vx1, vx0, delta, etaxdt;
    RARR *s;
    INFODIM *dims;
    ...
    #pragma omp parallel private(tsz,tid,iy,iz,_px,_py,_pz,_pxend,_mpx,_epx,_vx3,_vy3,_vy2,_vy1,_vy0,_vz3,_vz2,_vz1,_vz0,vx3,vx2,vx1,vx0,delta,etaxdt,dims)
    {
        #ifdef _OPENMP
        tsz = omp_get_num_threads();
        tid = omp_get_thread_num();
...
int sgn_ts3d_24v0(RDOM *dom, void *pars)
{
    ...
    #pragma omp parallel private(tsz,tid,iy,iz,_vx,_vxend,_mvx,_evx,_px3,px3,px2,px1,px0,etaxdt,dims)
    {
        #ifdef _OPENMP
        tsz = omp_get_num_threads();
        tid = omp_get_thread_num();
        ...
        dims = s[D_P0 ]._dims;
        _px3 = s[D_P0 ]._s + (gxs - dims[0].gs) + (gys - dims[1].gs + (tid - dims[2].gs) * dims[1].n0) * dims[0].n0 + 2;
        ...
        for ( iz = tid; iz < nz; iz += tsz )
        {
            ...
            _vx += vx_aa; _mvx += mvx_aa; _px3 += px_aa;
        }
    } /* omp parallel */
...
int sgn_ts3d_24vj(RDOM *dom, void *pars, int ind)
{
    ...
    la = ((SGN_TS_PARS*)pars)->lam[ind] * C24;
    dt2 = ((SGN_TS_PARS*)pars)->dt / 2.0;

    p_shift = s[D_p]._dims[0].n0 * ((ind == 1) ?  1 : s[D_p]._dims[1].n0);
    
    #pragma omp parallel private(tsz,tid,iy,iz,_v,_vend,_mv,_ev,_p3,_p2,_p1,_p0,etadt,dims)
    {
        #ifdef _OPENMP
        tsz = omp_get_num_threads();
        tid = omp_get_thread_num();
        ...
        dims = s[D_p ]._dims;
        _p1  = s[D_p ]._s + (gxs - dims[0].gs) + (gys - dims[1].gs + (tid - dims[2].gs) * dims[1].n0) * dims[0].n0;
        _p2  = _p1 + p_shift;
        _p3  = _p2 + p_shift;
        _p0  = _p1 - p_shift;
        ...
        for ( iz = tid; iz < nz; iz += tsz )
        {
            for ( iy = 0; iy < ny; ++iy )
            {
                ...
                {
                    (*_v) = ((*_v) * (1.0 - etadt) + ((*_p3++) - (*_p0++) + 
                             ((*_p1++) - (*_p2++)) * 27.0) * la * (*_mv++)) / (1.0 + etadt);
                    _v++;
                }

                _v += v_a; _mv += mv_a; _p0 += p_a; _p1 += p_a; _p2 += p_a; _p3 += p_a; _ev += ev_a;
            }

            _v += v_aa; _mv += mv_aa; _p0 += p_aa; _p1 += p_aa; _p2 += p_aa; _p3 += p_aa; _ev += ev_aa;
        }
    } /* omp parallel */
