...
#    Flow('hdr.su','data tdata','suwrite tfile=${SOURCES[1]} endian=0')
    ...
    os.system('suspike ntr=1 nt=551  offset=0 nspk=1 ix1=1 it1=201 dt=0.002 | sushw key=delrt  a=-400 |sufilter f=0.,2.5,15.0,20.0 amps=0.,1.,1.,0. | sugain scale=1.e6 > ' + TMPDATAPATH + '/wavelet.su')
    os.system('suspike ntr=1 nt=5  offset=0 nspk=1 ix1=1 it1=1 dt=0.002 > ' + TMPDATAPATH + '/testwavelet.su')
    os.system('sunull nt=1501 ntr=301 dt=0.002 | sushw key=sx a=3300 c=0 j=301 | sushw key=sy a=3300 c=0 j=301 | sushw key=gx a=100 b=20 j=301 | sushw key=gy a=3100 c=0 j=301 | sushw key=delrt a=0| sushw key=selev a=-40 | sushw key=gelev a=-20 > ' + TMPDATAPATH + '/hdr3d.su')
#    os.system('sunull nt=11 ntr=1 dt=0.002 | sushw key=sx a=500 c=0 j=1 | sushw key=sy a=500 c=0 j=1 | sushw key=gx a=200 b=20 j=1 | sushw key=gy a=200 c=0 j=1 | sushw key=delrt a=0| sushw key=selev a=-200 | sushw key=gelev a=-200 > ' + TMPDATAPATH + '/hdrtest.su')
