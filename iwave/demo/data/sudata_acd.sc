...
#    Flow('hdr.su','data tdata','suwrite tfile=${SOURCES[1]} endian=0')
    ...
    os.system('suspike ntr=1 nt=501  offset=0 nspk=1 ix1=1 it1=201 dt=0.002 | sushw key=gx a=3300 | sushw key=gelev a=-40 | sushw key=delrt  a=-400 |sufilter f=0.,2.5,15.0,20.0 amps=0.,1.,1.,0. | sugain scale=1.e6 > ' + TMPDATAPATH + '/wavelet_fixcoord.su')
