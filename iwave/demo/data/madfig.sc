...
# plot model fields
Result('vp', './vp2d_5m/vp2d_5m.rsf','put label1=Depth unit1=m label2 = Distance unit2=m label=Velocity unit=m/ms | grey color=3 mean=y title="Dome Velocity Model dx = dz = 5 m" scalebar=y barreverse=y')

Result('dn', './dn2d_5m/dn2d_5m.rsf','put label1=Depth unit1=m label2 = Distance unit2=m label=Density unit=g/cm^3 | grey color=3 mean=y title="Dome Velocity Model dx = dz = 5 m" scalebar=y barreverse=y')
