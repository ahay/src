...
/**
 ...
 can be defined in terms of generalized time step function, by passing dom as pdom, rdom, and cdom
 */
typedef int (*TIMESTEP_FUN)(RDOM * dom, int ia, void* fdpars);
...
/*
 ...
 int (*tsa)(RDOM *,int,FD_MODEL *);
 int (*tsfm)(RDOM *,RDOM *, RDOM *,int,FD_MODEL *);
 int (*tsam)(RDOM *,RDOM *, RDOM *,int,FD_MODEL *);
 int (*ptsf)(RDOM *, int, IMODEL *);
