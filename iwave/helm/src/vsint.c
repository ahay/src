...
/* Subroutine */ int vsint_(integer *m, integer *n, real *x, real *xt, 
	integer *mdimx, real *wsave)
{
    ...
    static real scale, sqrth;
    extern /* Subroutine */ int vrfftf_(integer *, integer *, real *, real *, 
	    integer *, real *);
