...
run(
    pipeline(
        `echo n1=5 data_format=ascii_uchar in=test_inp_uchar.txt
         out=stdout`,
...
run(
    pipeline(
        `echo n1=5 data_format=ascii_char in=test_inp_char.txt out=stdout`,
...
println("    read")
dat, n, d, o, l, u =
    sfspike(n1 = 4, n2 = 2, nsp = 2, k1 = (1, 2), mag = (1, 3)) |>
    x -> sfwindow(x; n1 = 1, squeeze = false) |> rsf_read
@test dat ≈ [1.0 1.0]
@test n == [1, 2]
@test d ≈ [0.004, 0.1]
@test o ≈ [0, 0]
...
dat, n, d, o, l, u =
    sfspike(n1 = 4, nsp = 2, k1 = (1, 2), mag = (1, 3)) |>
    sfrtoc |>
    x -> sfmath(x; output = "input + I") |> x -> sfwindow(x; n1 = 3) |> rsf_read
...
dat, n, d, o, l, u =
    rsf_write([5 2; 3 4], d = [0.1, 0.2], o = [1, 2], l = ["t", "x"], u = ["s", "m"]) |>
    rsf_read
@test dat ≈ [5 2; 3 4]
@test n == [2, 2]
@test d ≈ [0.1, 0.2]
