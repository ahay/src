...
int main(int argc, char ** argv) {
  ...
  // make a sim
  StdVector<RnState, std::allocator<RnState> > myStack;

  RASim<RnState> f(stp,tt,aa,myStack);
  ...
  cout << "Reference adjoint output = " << Dyn1_Adj_Soln(0) << endl;
  cout << "this adjoint output = " <<  astp.getState().getrn().u[0] << endl; 
