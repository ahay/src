    ...
    for (i1 = s[1]; i1 < e[1]+1; ++i1)
        for (i0 = s[0]; i0 < e[0]+1; ++i0) {
            upd[i1][i0] = 2.0*ucd[i1][i0] - upd[i1][i0] + csqd[i1][i0
                ...
                ]*(uc[i1+2][i0]+uc[i1-2][i0])) + csq[i1][i0]*(c0*ucd
                [i1][i0]+c1[0]*(ucd[i1][i0+1]+ucd[i1][i0-1])+c1[1]*(ucd[i1+1][
                i0]+ucd[i1-1][i0])+c2[0]*(ucd[i1][i0+2]+ucd[i1][i0-2])+c2[1]*(
                ucd[i1+2][i0]+ucd[i1-2][i0]));
        }
