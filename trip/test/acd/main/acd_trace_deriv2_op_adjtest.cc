...
*/
    TEST_F(ACDTraceOpAdjTest, wetrun_adjtest_cv_fdord2_deriv2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDTraceOpAdjTest, wetrun_adjtest_cv_fdord2_deriv2\n\n";
            ...
            AssignFilename mfn0("../csq.rsf");
            cm[0].eval(mfn0);
            AssignFilename dmfn0("../csq_spike.rsf");
            cdm[0].eval(dmfn0);
    ...
    TEST_F(ACDTraceOpAdjTest, wetrun_adjtest_dome_fdord2_deriv2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDTraceOpAdjTest, wetrun_adjtest_dome_fdord2_deriv2\n\n";
    ...
    TEST_F(ACDTraceOpAdjTest, wetrun_adjtest_dome_fdord4_deriv2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDTraceOpAdjTest, wetrun_adjtest_dome_fdord4_deriv2\n\n";
    ...
    TEST_F(ACDTraceOpAdjTest, wetrun_adjtest_dome_fdord8_deriv2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDTraceOpAdjTest, wetrun_adjtest_dome_fdord4_deriv2\n\n";
