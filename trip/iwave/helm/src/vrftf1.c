...
/* Subroutine */ int vrftf1_(integer *m, integer *n, real *c__, real *ch, 
	integer *mdimc, real *wa, real *fac)
{
    ...
    static integer i__, j, k1, l1, l2, na, kh, nf, ip, iw, ix2, ix3, ix4, ido,
	     idl1;
    static real scale;
    extern /* Subroutine */ int vradf2_(integer *, integer *, integer *, real 
	    *, real *, integer *, real *), vradf3_(integer *, integer *, 
	    integer *, real *, real *, integer *, real *, real *), vradf4_(
	    integer *, integer *, integer *, real *, real *, integer *, real *
	    , real *, real *), vradf5_(integer *, integer *, integer *, real *
	    , real *, integer *, real *, real *, real *, real *), vradfg_(
