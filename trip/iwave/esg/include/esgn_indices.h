...
#define D_MP02 D_MP01		 /* lambda */

/*< vz */
#define D_V0   3
#define D_MV0  4		/* 1/rho */
...
/*< px */
#define D_P1   7
#define D_MP10 D_MP01		/* lambda */
#define D_MP11 D_MP00		/* lambda + 2 mu */
#define D_MP12 D_MP01		/* lambda */

/*< vx */
#define D_V1  8
#define D_MV1 9			/* 1/rho */
...
/*< py */
#define D_P2   12
#define D_MP20 D_MP01		/* lambda */
#define D_MP21 D_MP01		/* lambda */
#define D_MP22 D_MP00		/* lambda + 2 mu */

/*< vy */
#define D_V2   13
#define D_MV2  14		/* 1/rho */
...
#if RARR_MAX_NDIM == 2
static const IPNT D_S  = {D_S0 , D_S1 }; //MB replace with: {D_S0,-1}?
