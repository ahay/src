...
"       homogeneous fluid ",
"       ",
"       refbou    = [float] [Default = 0.001 kg/m^3] bouyancy in hypothetical",
"       homogeneous fluid",
"       ",
...
" refbouy  = [float] [default = 0.001 m^3/kg],",
...
" modulus (refkappa) and bouyancy (refbouy) have priority: the other two are used",
" only if one of these is not given.",
" ",
" ",
" 4. Direct specification of bouyancy from RSF file, rather than density:",
" ",
" bouyancy = [string]",
" ",
" ",
" ",
" 5. Direct specification of bouyancy or density on shifted grids:",
" ",
"   bouyancy1 = [string] and",
"   bouyancy2 = [string] and",
"   bouyancy3 = [string], ",
"   ",
"   or",
"   ",
...
" components and bouyancies are obtained by shifting this grid by a",
