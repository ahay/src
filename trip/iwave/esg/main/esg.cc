...
/* NOTE: There are two versions of esg, Xin Wang's fixed version (with single 
   ...
   NOTE: Also, these implementations assume you are including boundary points, thus
         make sure to set INCLUDE_BOUNDARY_PNTS to 1 in fd.h.
*/
