/**
   ...
   time: 09/24/2011  
   2-10 stagger finite difference in 2D for isotropic elastic wave
*/
 ...
 */
int esgn_gts2d_210ns (RDOM *, RDOM *, RDOM *, void *, int);
/**
 * Shear stress updater of 2D stagger-grid 2-4 scheme for EWE  
 */
int esgn_gts2d_210ss0(RDOM *, RDOM *, RDOM *, void *, int);
/**
 * Velocity component vz updater of 2D stagger-grid 2-4 scheme for EWE  
 */
int esgn_gts2d_210v0 (RDOM *, RDOM *, RDOM *, void *, int);
/**
 * Velocity component vx updater of 2D stagger-grid 2-4 scheme for EWE  
 */
int esgn_gts2d_210v1 (RDOM *, RDOM *, RDOM *, void *, int);

int esgn_gts2d_210(RDOM *dom, RDOM *rdom, RDOM *cdom, int iarr, void *pars,int _fwd) {
  ...
  if ( iarr == D_P0 ) return esgn_gts2d_210ns (dom, rdom, cdom, esgnpars, _fwd);
  if ( iarr == D_S0 ) return esgn_gts2d_210ss0(dom, rdom ,cdom, esgnpars, _fwd);
  if ( iarr == D_V0 ) return esgn_gts2d_210v0 (dom, rdom, cdom, esgnpars, _fwd);
  if ( iarr == D_V1 ) return esgn_gts2d_210v1( dom, rdom, cdom, esgnpars, _fwd);
...
/*----------------------------------------------------------------------------*/
#ifdef VEC
int esgn_gts2d_210ns (RDOM *dom, RDOM *rdom, RDOM *cdom, void *pars, int _fwd) {
  
  fprintf(stderr, "Warning: VEC version 2D normal stress updater not implemented\n");
  return 0;
}

int esgn_gts2d_210ss0(RDOM *dom, RDOM *rdom, RDOM *cdom, void *pars, int _fwd) {

  fprintf(stderr, "Warning: VEC version 2D shear stress updater not implemented\n");
  return 0;
}

int esgn_gts2d_210v0 (RDOM *dom, RDOM *rdom, RDOM *cdom, void *pars, int _fwd) {
  
  fprintf(stderr, "Warning: VEC version 2D v0 updater not implemented\n");
  return 0;
}

int esgn_gts2d_210v1 (RDOM *dom, RDOM *rdom, RDOM *cdom, void *pars, int _fwd) {
