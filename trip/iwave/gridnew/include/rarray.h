...
/*----------------------------------------------------------------------------*/
/** 
 * Helper function - returns dimension based on principle: dimension = 
 * largest index for which start, end indices differ = loop limit for loop over
 * axes - not necessarily actual dimension of subarray
 * @param[in] s - start indices
 * @param[in] e - end indices
 * @return apparent dimension
 */
