...
const char * sdoc[] = {
  " Inversion velocity analysis based on acoustic constant density centered",
  " difference modeling in 2D or 3D.", 
  " ",
  ...
  " ",
  " \"sfacdiva [parameters]  [Madagascar install]\"",
  " ",
  " or ",
  " ",
  " \"acdiva.x [parameters] [standalone install]\"",
  " ",
  ...
  " Trace info:",
  " ",
  "          data  = <path>      input data file, SU format - must exist ",
