#ifndef __ACDPMLDS_GRAD_SELFDOC__
#define __ACDPMLDS_GRAD_SELFDOC__

const char * sdoc[] = {
" Differential Semblance objective function gradient test based on acoustic ",
" constant density centered difference modeling with perfectly matched ",
" layer (PML), in 2D.",
" ",
" Authors: Yin Huang, William W. Symes",
" ",
" Test Nhval finite difference steps from csq in direction csq_end - csq",
" ranging from HMin to HMax:",
" Compute directional derivative at point csq in direction csq_end - csq",
" ",
"          < grad f(csq), csq_end - csq > ",
" ",
" with centered finite difference approximations ",
" ",
"          (f(csq + h*(csq_end-csq))- f(csq + h*(csq_end-csq)))/(2*h) ",
" ",
" for Nhval values of h ranging from HMin to HMax.",
" ",
...
" ",
" \"sfacdds_grad [parameters]  [Madagascar install]\"",
" ",
" or ",
" ",
" \"acdds_grad.x [parameters] [standalone install]\"",
" ",
...
" GRAD test info:",
" ",
"        Nhval =  11           number of values of h from HMin to HMax",
"        HMin  =  0.1          ",
"        HMax  =  1.0          ",
" ",
" ------------------------------------------------------------------------",
