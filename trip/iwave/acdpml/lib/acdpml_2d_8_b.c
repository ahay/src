...
*/
void acdpml_2d_8_b(float **uc, float **ucb, float **up, float **upb, float **
    ...
    for (i1 = s[1]; i1 < e[1]+1; ++i1)
        for (i0 = s[0]; i0 < e[0]+1; ++i0)
            up[i1][i0] = 1.0/(1.0+(dp1[i1]+dp0[i0])*dt/2.0)*(uc[i1][i0]*(2.0-
                ...
                1])+c1[1]*(uc[i1+1][i0]+uc[i1-1][i0])+c2[0]*(uc[i1][i0+2]+uc[
                i1][i0-2])+c2[1]*(uc[i1+2][i0]+uc[i1-2][i0])+c3[0]*(uc[i1][i0+
                3]+uc[i1][i0-3])+c3[1]*(uc[i1+3][i0]+uc[i1-3][i0])+c4[0]*(uc[
                i1][i0+4]+uc[i1][i0-4])+c4[1]*(uc[i1+4][i0]+uc[i1-4][i0]))+dt*
                dt*(phi1[i1][i0-1]+phi1[i1][i0]-phi1[i1-1][i0-1]-phi1[i1-1][i0
                ])/2.0/di[1]+dt*dt*(phi0[i1-1][i0]+phi0[i1][i0]-phi0[i1-1][i0-
                1]-phi0[i1][i0-1])/2.0/di[0]);
    pushinteger4(i0);
    pushinteger4(i1);
    pushinteger4(i0);
    pushinteger4(i1);
