...
*/
void acdpml_2d_4_d_b(float **uc, float **ucb, float **ucd, float **ucdb, float
    ...
    for (i1 = s[1]; i1 < e[1]+1; ++i1)
        for (i0 = s[0]; i0 < e[0]+1; ++i0) {
            float lap = c0*uc[i1][i0] +
               c1[1]*(uc[i1-1][i0]+uc[i1+1][i0]) + c2[1]*(uc[i1-2][i0]+uc[i1+2][i0]) +
               c1[0]*(uc[i1][i0-1]+uc[i1][i0+1]) + c2[0]*(uc[i1][i0-2]+uc[i1][i0+2]);
            float lapd = c0*ucd[i1][i0] +
               c1[1]*(ucd[i1-1][i0]+ucd[i1+1][i0]) + c2[1]*(ucd[i1-2][i0]+ucd[i1+2][i0]) +
               c1[0]*(ucd[i1][i0-1]+ucd[i1][i0+1]) + c2[0]*(ucd[i1][i0-2]+ucd[i1][i0+2]);
    ...
    for (i1 = e[1]; i1 > s[1]-1; --i1)
        for (i0 = e[0]; i0 > s[0]-1; --i0) {
            ...
            ucb[i1][i0 + 2] = ucb[i1][i0 + 2] + c2[0]*tempb4;
            csqb[i1][i0] = csqb[i1][i0] + (c0*ucd[i1][i0]+c1[1]*(ucd[i1-1][i0]
                +ucd[i1+1][i0])+c2[1]*(ucd[i1-2][i0]+ucd[i1+2][i0])+c1[0]*(ucd
                [i1][i0-1]+ucd[i1][i0+1])+c2[0]*(ucd[i1][i0-2]+ucd[i1][i0+2]))
                *tempb3;
