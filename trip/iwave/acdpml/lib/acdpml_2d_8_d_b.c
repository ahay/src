...
/*
  Differentiation of acdpml_2d_8_d in reverse (adjoint) mode:
...
*/
void acdpml_2d_8_d_b(float **uc, float **ucb, float **ucd, float **ucdb, float
        ...
        **phi1db, float **phi0, float **phi0b, float **phi0d, float **phi0db, 
        ...
        float *c1, float *c2, float *c3, float *c4, int *lbc, int *rbc) {
    /* current field
    // previous field
    // csq
    // phi1
    ...
    for (i1 = s[1]; i1 < e[1]+1; ++i1)
        for (i0 = s[0]; i0 < e[0]+1; ++i0) {
            float lap = c0*uc[i1][i0] +
                c1[0]*(uc[i1][i0+1]+uc[i1][i0-1]) + c1[1]*(uc[i1+1][i0]+uc[i1-1][i0]) +
                c2[0]*(uc[i1][i0+2]+uc[i1][i0-2]) + c2[1]*(uc[i1+2][i0]+uc[i1-2][i0]) +
                c3[0]*(uc[i1][i0+3]+uc[i1][i0-3]) + c3[1]*(uc[i1+3][i0]+uc[i1-3][i0]) +
                c4[0]*(uc[i1][i0+4]+uc[i1][i0-4]) + c4[1]*(uc[i1+4][i0]+uc[i1-4][i0]);
            float lapd = c0*ucd[i1][i0] +
                c1[0]*(ucd[i1][i0+1]+ucd[i1][i0-1]) + c1[1]*(ucd[i1+1][i0]+ucd[i1-1][i0]) +
                c2[0]*(ucd[i1][i0+2]+ucd[i1][i0-2]) + c2[1]*(ucd[i1+2][i0]+ucd[i1-2][i0]) +
                c3[0]*(ucd[i1][i0+3]+ucd[i1][i0-3]) + c3[1]*(ucd[i1+3][i0]+ucd[i1-3][i0]) +
                c4[0]*(ucd[i1][i0+4]+ucd[i1][i0-4]) + c4[1]*(ucd[i1+4][i0]+ucd[i1-4][i0]);
    ...
    for (i1 = e[1]; i1 > s[1]-1; --i1)
        for (i0 = e[0]; i0 > s[0]-1; --i0) {
            ...
            ucb[i1 - 1][i0] = ucb[i1 - 1][i0] + c1[1]*tempb4;
            ucb[i1][i0 + 2] = ucb[i1][i0 + 2] + c2[0]*tempb4;
            ucb[i1][i0 - 2] = ucb[i1][i0 - 2] + c2[0]*tempb4;
            ucb[i1 + 2][i0] = ucb[i1 + 2][i0] + c2[1]*tempb4;
            ucb[i1 - 2][i0] = ucb[i1 - 2][i0] + c2[1]*tempb4;
            ucb[i1][i0 + 3] = ucb[i1][i0 + 3] + c3[0]*tempb4;
            ucb[i1][i0 - 3] = ucb[i1][i0 - 3] + c3[0]*tempb4;
            ucb[i1 + 3][i0] = ucb[i1 + 3][i0] + c3[1]*tempb4;
            ucb[i1 - 3][i0] = ucb[i1 - 3][i0] + c3[1]*tempb4;
            ucb[i1][i0 + 4] = ucb[i1][i0 + 4] + c4[0]*tempb4;
            ucb[i1][i0 - 4] = ucb[i1][i0 - 4] + c4[0]*tempb4;
            ucb[i1 + 4][i0] = ucb[i1 + 4][i0] + c4[1]*tempb4;
            ucb[i1 - 4][i0] = ucb[i1 - 4][i0] + c4[1]*tempb4;
            csqb[i1][i0] = csqb[i1][i0] + (c0*ucd[i1][i0]+c1[0]*(ucd[i1][i0+1]
                ...
                ][i0]+ucd[i1-4][i0]))*tempb3;
            ucdb[i1][i0 + 1] = ucdb[i1][i0 + 1] + c1[0]*tempb5;
            ucdb[i1][i0 - 1] = ucdb[i1][i0 - 1] + c1[0]*tempb5;
            ucdb[i1 + 1][i0] = ucdb[i1 + 1][i0] + c1[1]*tempb5;
            ucdb[i1 - 1][i0] = ucdb[i1 - 1][i0] + c1[1]*tempb5;
            ucdb[i1][i0 + 2] = ucdb[i1][i0 + 2] + c2[0]*tempb5;
            ucdb[i1][i0 - 2] = ucdb[i1][i0 - 2] + c2[0]*tempb5;
            ucdb[i1 + 2][i0] = ucdb[i1 + 2][i0] + c2[1]*tempb5;
            ucdb[i1 - 2][i0] = ucdb[i1 - 2][i0] + c2[1]*tempb5;
            ucdb[i1][i0 + 3] = ucdb[i1][i0 + 3] + c3[0]*tempb5;
            ucdb[i1][i0 - 3] = ucdb[i1][i0 - 3] + c3[0]*tempb5;
            ucdb[i1 + 3][i0] = ucdb[i1 + 3][i0] + c3[1]*tempb5;
            ucdb[i1 - 3][i0] = ucdb[i1 - 3][i0] + c3[1]*tempb5;
            ucdb[i1][i0 + 4] = ucdb[i1][i0 + 4] + c4[0]*tempb5;
            ucdb[i1][i0 - 4] = ucdb[i1][i0 - 4] + c4[0]*tempb5;
            ucdb[i1 + 4][i0] = ucdb[i1 + 4][i0] + c4[1]*tempb5;
            ucdb[i1 - 4][i0] = ucdb[i1 - 4][i0] + c4[1]*tempb5;
