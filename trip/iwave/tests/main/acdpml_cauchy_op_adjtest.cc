...
= {
    ...
    {"uc_out",   1, false,  true},
    {"up_out",   2, false,  true},
    {"phi1_out", 3, false, true},
    {"phi0_out", 4, false, true},
    {"",       0, false, false}
};
...
namespace {
  ...
  class ACDPMLCauchyOpAdjTest : public ::testing::Test {
  public:

    IWaveInfo ic;
    ofstream rpt;

    ACDPMLCauchyOpAdjTest(): ic() {
      ...
      qs<<"------------------------------------------------------------------------\n";
        ...
        qs<<"          uc_in = u_in.rsf\n";
        qs<<"          up_in = u_in.rsf\n";
        qs<<"        phi1_in = phi_in.rsf\n";
        qs<<"        phi0_in = phi_in.rsf\n";
        qs<<"         uc_out = u_out.rsf\n";
        qs<<"         up_out = u_out.rsf\n";
        qs<<"       phi1_out = phi_out.rsf\n";
        qs<<"       phi0_out = phi_out.rsf\n";
        qs<<"\n";
      qs<<"------------------------------------------------------------------------\n";
      qs<<"PML info:\n";
      qs<<"\n";
      qs<<"LZ = 40\n";
      qs<<"LX = 40\n";
      qs<<"pmlampl = 0.05   set to 0.0 turn off pml\n";
      qs<<"\n";
      qs<<"------------------------------------------------------------------------\n";
      qs<<"MPI info:\n";
      qs<<"\n";
      ...
      qs<<"------------------------------------------------------------------------\n";
        ...
        qs<<"       phi1_out = phi_out3.rsf\n";
        qs<<"       phi0_out = phi_out3.rsf\n";
        qs<<"\n";
      qs<<"------------------------------------------------------------------------\n";
      qs<<"PML info:\n";
      qs<<"\n";
      ...
      qs<<"------------------------------------------------------------------------\n";
        ...
        qs<<"       phi1_out = phi_out100.rsf\n";
        qs<<"       phi0_out = phi_out100.rsf\n";
        qs<<"\n";
      qs<<"------------------------------------------------------------------------\n";
      qs<<"PML info:\n";
      qs<<"\n";
      ...
      create_hfile("phi_out.rsf",g,val);
      ...
      create_hfile("phi_out3.rsf",g,val);
      ...
      create_hfile("phi_out100.rsf",g,val);


    }

    ~ACDPMLCauchyOpAdjTest() { rpt.close(); }
  };

  TEST_F(ACDPMLCauchyOpAdjTest, dryrun_op_onestep_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, dryrun_op_onestep_ord1\n\n";
      ...
      int seed = 19490615;
      RVL::RVLRandomize<float> rnd(seed,0.0f,1.0f);
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uonly_onestep_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uonly_onestep_ord1\n\n";
      // fake command line environment
      int argc = 2;
      char * argvv = new char[128];
      char ** argv = new char*[2];
      ...
      rpt << "dm[3].norm = " << cdm[3].norm() << endl;
      rpt << "dm[4].norm = " << cdm[4].norm() << endl;
      rpt << "\n=======  Ax ========================\n";
      rpt << "dd[0].norm = " << cdd[0].norm() << endl;
      rpt << "dd[1].norm = " << cdd[1].norm() << endl;
      rpt << "dd[2].norm = " << cdd[2].norm() << endl;
      rpt << "dd[3].norm = " << cdd[3].norm() << endl;
      rpt << "\n=======   y [ucb, upb, phi1, phi0] =============\n";
      rpt << "bd[0].norm = " << cbd[0].norm() << endl;
      rpt << "bd[1].norm = " << cbd[1].norm() << endl;
      rpt << "bd[2].norm = " << cbd[2].norm() << endl;
      rpt << "bd[3].norm = " << cbd[3].norm() << endl;
      rpt << "\n=======A^Ty [csqb, ucb, upb, phi1, phi0] =======\n";
      rpt << "bm[0].norm = " << cbm[0].norm() << endl;
      rpt << "bm[1].norm = " << cbm[1].norm() << endl;
      rpt << "bm[2].norm = " << cbm[2].norm() << endl;
      rpt << "bm[3].norm = " << cbm[3].norm() << endl;
      rpt << "bm[4].norm = " << cbm[4].norm() << endl;
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_conly_onestep_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_conly_onestep_ord1\n\n";
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_ord1\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_fd4_ord1) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_fd4_ord1\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_fd8_ord1) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_fd8_ord1\n\n";
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, dryrun_op_3step_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, dryrun_op_3step_ord1\n\n";
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uonly_3step_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uonly_3step_ord1\n\n";
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_conly_3step_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_conly_3step_ord1\n\n";
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_ord1\n\n";
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd4_ord1) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd4_ord1\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd8_ord1) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd8_ord1\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_conly_100step_ord1) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_conly_100step_ord1\n\n";
            ...
            int seed = getpid();
            RVL::RVLRandomize<float> rnd(seed,-1.0f,1.0f);
            RVL::RVLRandomize<float> rnd1 (seed,0.0f,1.0f);
  ...
  TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_ord1) {
    try {
      rpt<<"\n======================================================\n";
      rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_ord1\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd4_ord1) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd4_ord1\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd8_ord1) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd8_ord1\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_conly_onestep_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_conly_onestep_ord2\n\n";
            ...
            rpt << "dd[2].norm = " << cdd[2].norm() << endl;
            rpt << "dd[3].norm = " << cdd[3].norm() << endl;
            rpt << "\n=======   y [ucbd, upbd, phi1bd, phi0bd] =============\n";
            rpt << "bd[0].norm = " << cbd[0].norm() << endl;
            rpt << "bd[1].norm = " << cbd[1].norm() << endl;
            rpt << "bd[2].norm = " << cbd[2].norm() << endl;
            rpt << "bd[3].norm = " << cbd[3].norm() << endl;
            rpt << "\n=======A^Ty [csqb, ucb, upb, phi1b, phi0b] =======\n";
            rpt << "bm[0].norm = " << cbm[0].norm() << endl;
            rpt << "bm[1].norm = " << cbm[1].norm() << endl;
            rpt << "bm[2].norm = " << cbm[2].norm() << endl;
            rpt << "bm[3].norm = " << cbm[3].norm() << endl;
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_fd4_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_fd4_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_onestep_fd8_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_1step_fd4_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, dryrun_op_3step_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, dryrun_op_3step_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd4_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd4_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd8_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_3step_fd4_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd4_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd4_ord2\n\n";
    ...
    TEST_F(ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd8_ord2) {
        try {
            rpt<<"\n======================================================\n";
            rpt<<"ACDPMLCauchyOpAdjTest, wetrun_op_uandc_100step_fd4_ord2\n\n";
