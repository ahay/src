...
// inverse Fourier transform
    ...
    for (ix=nx2/2; ix<nx2; ix++) {
        ...
        for (iz=nzc/2; iz<nzc; iz++) {
            wz = (iz-nzc) * (iz-nzc);
//            dd[ix*nzc+iz][0]=c[ix*nzc+iz][0]*(sqrt(weightx * wx + weightz * wz));
//            dd[ix*nzc+iz][1]=c[ix*nzc+iz][1]*(sqrt(weightx * wx + weightz * wz));
//            dd[ix*nzc+iz][0]=c[ix*nzc+iz][0]/(sqrt(1+weightx * wx + weightz * wz));
//            dd[ix*nzc+iz][1]=c[ix*nzc+iz][1]/(sqrt(1+weightx * wx + weightz * wz));
            dd[ix*nzc+iz][0]=c[ix*nzc+iz][0]*(pow(1+weightx * wx + weightz * wz, power));
            dd[ix*nzc+iz][1]=c[ix*nzc+iz][1]*(pow(1+weightx * wx + weightz * wz, power));
        }
    }
