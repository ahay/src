...
/* Subroutine */ int sint2d_(integer *m, integer *n, real *x, real *xt, real *
	wsave)
{
    ...
    extern /* Subroutine */ int f2c_scopy(integer *, real *, integer *, real *, 
	    integer *), vsint_(integer *, integer *, real *, real *, integer *
	    , real *), vsinti_(integer *, real *);
